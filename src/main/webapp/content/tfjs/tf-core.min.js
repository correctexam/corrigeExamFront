...
!(function (e, t) {
        ...
        return (function (o) {
          ...
          for (; i; )
            try {
              if (
                ((n = 1),
                r && (a = 2 & o[0] ? r.return : o[0] ? r.throw || ((a = r.return) && a.call(r), 0) : r.next) && !(a = a.call(r, o[1])).done)
              )
                return a;
  ...
  function b(e, t) {
    ...
    for (var n = 0; n < e.length; n++) if (null !== e[n] && null !== t[n] && e[n] !== t[n]) return !1;
    return !0;
  }
  function w(e, t) {
    if (e === t) return !0;
  ...
  function S(e, t) {
    for (
      var n = [], r = [], a = null != t && Array.isArray(t) && 0 === t.length, o = null == t || a ? null : E(t, e).sort(), i = 0, s = 0;
      s < e.length;
      ++s
    ) {
      if (null != o) {
        if (o[i] === s && 1 !== e[s]) throw new Error("Can't squeeze axis ".concat(s, " since its dim '").concat(e[s], "' is not 1"));
  ...
  function L(e, t, n, r) {
    void 0 === r && (r = !1);
    var a = new Array();
    if (1 === t.length) for (var o = t[0] * (r ? 2 : 1), i = 0; i < o; i++) a[i] = n[e + i];
    else {
      o = t[0];
      var s = t.slice(1),
        u =
    ...
    H = (function () {
      ...
      return (
        (e.prototype.setPlatform = function (e, t) {
          null != this.platform &&
            (J().getBool('IS_TEST') ||
              J().getBool('PROD') ||
              console.warn(
                'Platform '.concat(this.platformName, ' has already been set. ') + 'Overwriting the platform with '.concat(e, '.'),
              )),
            (this.platformName = e),
            (this.platform = t);
        }),
        ...
        (e.prototype.getAsync = function (e) {
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (r) {
              switch (r.label) {
                case 0:
                  return e in this.flags ? [2, this.flags[e]] : ((t = this.flags), (n = e), [4, this.evaluateFlag(e)]);
                case 1:
        ...
        (e.prototype.get = function (e) {
          ...
          if (K(t)) throw new Error('Flag '.concat(e, ' cannot be synchronously evaluated. ') + 'Please use getAsync() instead.');
  ...
  function X(e, t) {
    var n,
      r = (null == (n = Y())._tfGlobals && (n._tfGlobals = new Map()), n._tfGlobals);
  ...
  function Bn() {
    ...
    J().getBool('IS_TEST') || J().getBool('PROD') || console.warn.apply(console, u([], s(e), !1));
  }
  ...
  function zn(e) {
    var t = e.kernelName,
      n = e.backendName,
      r = Un(t, n);
    Fn.has(r) && Bn("The kernel '".concat(t, "' for backend ") + "'".concat(n, "' is already registered")), Fn.set(r, e);
  }
  function Un(e, t) {
  ...
  Hn.prototype.__isLong__, Object.defineProperty(Hn.prototype, '__isLong__', { value: !0 }), (Hn.isLong = jn);
  var Zn = {},
    Jn = {};
  function Yn(e, t) {
    var n, r, a;
    return t
      ? (a = 0 <= (e >>>= 0) && e < 256) && (r = Jn[e])
        ? r
        : ((n = Qn(e, (0 | e) < 0 ? -1 : 0, !0)), a && (Jn[e] = n), n)
      : (a = -128 <= (e |= 0) && e < 128) && (r = Zn[e])
      ? r
      : ((n = Qn(e, e < 0 ? -1 : 0, !1)), a && (Zn[e] = n), n);
  }
  function Xn(e, t) {
  ...
  function tr(e, t) {
    return 'number' == typeof e ? Xn(e, t) : 'string' == typeof e ? er(e, t) : Qn(e.low, e.high, 'boolean' == typeof t ? t : e.unsigned);
  }
  ...
  (pr.toInt = function () {
    ...
    (pr.toNumber = function () {
      return this.unsigned ? (this.high >>> 0) * nr + (this.low >>> 0) : this.high * nr + (this.low >>> 0);
    }),
    ...
    (pr.add = function (e) {
      ...
      return (
        ...
        (u += (c += n + i) >>> 16),
        (u += t + o),
        Qn(((l &= 65535) << 16) | (h &= 65535), ((u &= 65535) << 16) | (c &= 65535), this.unsigned)
      );
    }),
    ...
    (pr.multiply = function (e) {
      ...
      if ((jn(e) || (e = tr(e)), Vn)) return Qn(Vn.mul(this.low, this.high, e.low, e.high), Vn.get_high(), this.unsigned);
      ...
      return (
        ...
        (c += (l += a * i) >>> 16),
        (c += t * u + n * s + r * i + a * o),
        Qn(((h &= 65535) << 16) | (f &= 65535), ((c &= 65535) << 16) | (l &= 65535), this.unsigned)
      );
    }),
    (pr.mul = pr.multiply),
    (pr.divide = function (e) {
      ...
      if (Vn)
        return this.unsigned || -2147483648 !== this.high || -1 !== e.low || -1 !== e.high
          ? Qn((this.unsigned ? Vn.div_u : Vn.div_s)(this.low, this.high, e.low, e.high), Vn.get_high(), this.unsigned)
          : this;
      ...
      for (n = this; n.gte(e); ) {
        ...
        for (
          var a = Math.ceil(Math.log(t) / Math.LN2), o = a <= 48 ? 1 : $n(2, a - 48), i = Xn(t), s = i.mul(e);
          s.isNegative() || s.gt(n);
    ...
    (pr.modulo = function (e) {
      return (
        jn(e) || (e = tr(e)),
        Vn
          ? Qn((this.unsigned ? Vn.rem_u : Vn.rem_s)(this.low, this.high, e.low, e.high), Vn.get_high(), this.unsigned)
    ...
    (pr.shiftLeft = function (e) {
      return (
        ...
        0 == (e &= 63)
          ? this
          : e < 32
          ? Qn(this.low << e, (this.high << e) | (this.low >>> (32 - e)), this.unsigned)
    ...
    (pr.shiftRight = function (e) {
      return (
        ...
        0 == (e &= 63)
          ? this
          : e < 32
          ? Qn((this.low >>> e) | (this.high << (32 - e)), this.high >> e, this.unsigned)
    ...
    (pr.shiftRightUnsigned = function (e) {
      ...
      var t = this.high;
      return e < 32 ? Qn((this.low >>> e) | (t << (32 - e)), t >>> e, this.unsigned) : Qn(32 === e ? t : t >>> (e - 32), 0, this.unsigned);
    }),
  ...
  var gr = Kn(qn),
    vr = gr || t({ __proto__: null, default: gr }, [qn]);
  function mr(e) {
  ...
  function Tr(e, t) {
    return void 0 === t && (t = 'utf-8'), (t = t || 'utf-8'), J().platform.encode(e, t);
  }
  function Dr(e, t) {
    return void 0 === t && (t = 'utf-8'), (t = t || 'utf-8'), J().platform.decode(e, t);
  }
  function Rr(e) {
    return null != J().platform.isTypedArray ? J().platform.isTypedArray(e) : Wn(e);
  }
  function Br(e, t, n) {
    var r, a;
    if (
      ...
      void 0 === n && (n = !1),
      null == t && (t = []),
      'boolean' == typeof e || 'number' == typeof e || 'string' == typeof e || K(e) || null == e || (Rr(e) && n))
    )
      t.push(e);
    else if (Array.isArray(e) || Rr(e)) for (var o = 0; o < e.length; ++o) Br(e[o], t, n);
    else {
      var s = -1;
      try {
  ...
  var Fr = {
      ...
      fingerPrint64: function (e, t) {
        ...
        if (t <= 32)
          return t <= 16
            ? (function (e, t) {
                ...
                if (t >= 4) return (n = wr.add(2 * t)), _r((r = Sr(e, 0)).shl(3).add(t), Sr(e, t - 4), n);
                if (t > 0) {
                  var a,
                    o = (r = e[0]) + ((a = e[t >> 1]) << 8),
                    i = t + (e[t - 1] << 2);
            ...
            : (function (e, t) {
                ...
                var n = wr.add(2 * t),
                  ...
                  o = Er(e, t - 8).mul(n),
                  i = Er(e, t - 16).mul(wr);
                return _r(Ar(r.add(a), 43).add(Ar(o, 30)).add(i), r.add(Ar(a.add(wr), 18)).add(o), n);
              })(e, t);
        if (t <= 64)
          return (function (e, t) {
            void 0 === t && (t = e.length);
            ...
            return _r(Ar(c.add(l), 43).add(Ar(h, 30)).add(f), c.add(Ar(l.add(r), 18)).add(h), n);
          })(e, t);
        var o = a,
          i = a.mul(br).add(113),
        ...
        return (
          ...
          (u = (r = s([o, u], 2))[0]),
          (o = r[1]),
          _r(_r(c[0], l[0], p).add(kr(i).mul(yr)).add(u), _r(c[1], l[1], p).add(o), p)
        );
      },
      flatten: Br,
      getArrayFromDType: _,
            ...
            var i = 0,
              s = function () {
                if (e()) a();
                  ...
                  i++;
                  var u = t(i);
                  null != n && i >= n ? o() : null != r ? r(s, u) : setTimeout(s, u);
                }
              };
            s();
          })
      ...
      shuffleCombo: function (e, t) {
        ...
        for (var n = e.length, r = 0; n > 0; ) (r = (Math.random() * n) | 0), p(e, --n, r), p(t, n, r);
      },
      sizeFromShape: y,
  ...
  var Pr = (function () {
    ...
    return (
      (e.prototype.logKernelProfile = function (e, t, n, r, a, o) {
        ...
        console.log(
          '%c'.concat(s, '\t%c').concat(i, '\t%c').concat(u, 'D ').concat(l, '\t%c').concat(c, '\t%c').concat(h, '\t%c').concat(o),
          'font-weight:bold',
          'color:red',
          'color:blue',
          'color: orange',
  ...
  function Or(e, t, n, r) {
    var a = O(t),
      o = (function (e, t, n, r) {
        ...
        if (s > 1) for (var c = 0; c < a / o; c++) for (var l = c * o, h = 0; h < o; h++) i[h] = Math.max(i[h], Lr(u[l + h], 0, n).length);
        return i;
      })(e, t, n, a),
      i = t.length,
      s = Ur(e, t, n, a, o),
      u = ['Tensor'];
    return (
      r && (u.push('  dtype: '.concat(n)), u.push('  rank: '.concat(i)), u.push('  shape: ['.concat(t, ']')), u.push('  values:')),
      u.push(
        s
          .map(function (e) {
            return '    ' + e;
  ...
  function Lr(e, t, n) {
    return x(
      Array.isArray(e)
        ? ''.concat(parseFloat(e[0].toFixed(7)), ' + ') + ''.concat(parseFloat(e[1].toFixed(7)), 'j')
        : D(e)
        ? "'".concat(e, "'")
        : 'bool' === n
        ? zr(e)
  ...
  function Ur(e, t, n, r, a, o) {
    ...
    var i = 'complex64' === n ? 2 : 1,
      c = t[0],
      l = t.length;
    if (0 === l) return 'complex64' === n ? [Lr(Wr(e)[0], 0, n)] : 'bool' === n ? [zr(e[0])] : [e[0].toString()];
    if (1 === l) {
      if (c > 20) {
        var h = 3 * i,
      ...
      function e(e, t, n) {
        ...
        if (((this.dtype = t), (this.shape = e.slice()), (this.size = y(e)), null != n)) {
          ...
          g(a === this.size, function () {
            return "Length of values '".concat(a, "' does not match the size ") + "inferred by the shape '".concat(r.size, "'.");
          });
        }
        if ('complex64' === t)
          throw new Error(
        ...
        (e.prototype.set = function (e) {
          ...
          0 === n.length && (n = [0]),
            g(n.length === this.rank, function () {
              return 'The number of provided coordinates ('.concat(n.length, ') must ') + 'match the rank ('.concat(t.rank, ')');
            });
          ...
          try {
            for (var o = i(n), s = o.next(); !s.done; s = o.next()) {
              ...
              if (u < 0 || u >= this.shape[a]) {
                var c = 'Requested out of range element at '.concat(n, '. ') + '  Buffer shape='.concat(this.shape);
                throw new Error(c);
              }
              a++;
            }
  ...
  var Vr = (function () {
    ...
    return (
          ...
          return o(this, function (t) {
            switch (t.label) {
              case 0:
                return [4, this.data()];
              case 1:
                return (e = t.sent()), [2, qr.buffer(this.shape, this.dtype, e)];
            }
          });
        });
      }),
      (e.prototype.bufferSync = function () {
        return qr.buffer(this.shape, this.dtype, this.dataSync());
      }),
          ...
          return o(this, function (t) {
            switch (t.label) {
              case 0:
                return [4, this.data()];
              case 1:
                return (e = t.sent()), [2, z(this.shape, e, 'complex64' === this.dtype)];
            }
          });
        });
      }),
      ...
      (e.prototype.data = function () {
        return a(this, void 0, void 0, function () {
          ...
          return o(this, function (n) {
            switch (n.label) {
              case 0:
                return this.throwIfDisposed(), (e = Kr().read(this.dataId)), 'string' !== this.dtype ? [3, 2] : [4, e];
              case 1:
                t = n.sent();
                try {
                  return [
      ...
      (e.prototype.dataToGPU = function (e) {
        return this.throwIfDisposed(), Kr().readToGPU(this.dataId, e);
      }),
      (e.prototype.dataSync = function () {
        this.throwIfDisposed();
        var e = Kr().readSync(this.dataId);
      ...
      (e.prototype.bytes = function () {
        return a(this, void 0, void 0, function () {
          ...
          return o(this, function (t) {
            switch (t.label) {
              case 0:
                return this.throwIfDisposed(), [4, Kr().read(this.dataId)];
              case 1:
      ...
      (e.prototype.dispose = function () {
        this.isDisposed || (this.kerasMask && this.kerasMask.dispose(), Kr().disposeTensor(this), (this.isDisposedInternal = !0));
      }),
      ...
      (e.prototype.print = function (e) {
        return void 0 === e && (e = !1), qr.print(this, e);
      }),
      (e.prototype.clone = function () {
        return this.throwIfDisposed(), qr.clone(this);
      }),
      (e.prototype.toString = function (e) {
        return void 0 === e && (e = !1), Or(this.dataSync(), this.shape, this.dtype, e);
      }),
      (e.prototype.cast = function (e) {
        return this.throwIfDisposed(), qr.cast(this, e);
      }),
      (e.prototype.variable = function (e, t, n) {
        return void 0 === e && (e = !0), this.throwIfDisposed(), Kr().makeVariable(this, e, t, n);
      }),
      e
    );
  })();
    ...
    Qr = (function (e) {
      ...
      return (
        ...
        (t.prototype.assign = function (e) {
          ...
          Kr().disposeTensor(this), (this.dataId = e.dataId), Kr().incRef(this, null);
        }),
  ...
  var $r = { float32: Yr, int32: Zr, bool: Jr, complex64: Xr };
  function ea(e, t) {
  ...
  var ca = (function () {
    ...
    la = (function () {
      function e(e) {
        (this.ENV = e), (this.registry = {}), (this.registryFactory = {}), (this.pendingBackendInitId = 0), (this.state = new ca());
      }
      return (
          ...
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (r) {
              switch (r.label) {
                ...
                case 1:
                  return t < e.length ? ((n = e[t]), [4, this.initializeBackend(n).success]) : [3, 5];
                case 2:
        ...
        Object.defineProperty(e.prototype, 'backend', {
          get: function () {
            if (null != this.pendingBackendInit)
              throw new Error(
                "Backend '".concat(this.backendName, "' has not yet been initialized. Make ") +
            ...
            if (null == this.backendInstance) {
              ...
              if (e.asyncInit)
                throw new Error(
                  "The highest priority backend '".concat(t, "' has not yet been ") +
        ...
        (e.prototype.registerBackend = function (e, t, n) {
          return (
            ...
            e in this.registryFactory
              ? (Bn(''.concat(e, ' backend was already registered. ') + 'Reusing existing backend factory.'), !1)
        ...
        (e.prototype.setBackend = function (e) {
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (a) {
              switch (a.label) {
                case 0:
                  if (null == this.registryFactory[e]) throw new Error("Backend name '".concat(e, "' not found in registry"));
                  return (
                    (this.backendName = e),
                    null != this.registry[e]
                      ? [3, 4]
                      : ((this.backendInstance = null), (t = this.initializeBackend(e)), (n = t.success), t.asyncInit ? [4, n] : [3, 2])
                  );
                case 1:
                  return (r = a.sent()), [3, 3];
                case 2:
        ...
        (e.prototype.initializeBackend = function (e) {
          ...
          try {
            var r = n.factory();
            if (!r || r instanceof l || 'function' != typeof r.then) return (this.registry[e] = r), { success: !0, asyncInit: !1 };
                ...
                .catch(function (n) {
                  return (
                    a < t.pendingBackendInitId ||
                      ((t.pendingBackendInit = null), Bn('Initialization of backend '.concat(e, ' failed')), Bn(n.stack || n.message)),
                    !1
                  );
                });
            return (this.pendingBackendInit = o), { success: o, asyncInit: !0 };
          } catch (t) {
            return Bn('Initialization of backend '.concat(e, ' failed')), Bn(t.stack || t.message), { success: !1, asyncInit: !1 };
          }
        }),
        ...
        (e.prototype.runKernel = function (e, t, n) {
          if ((null == this.backendName && this.backend, !(null != Pn(e, this.backendName))))
            throw new Error("Kernel '".concat(e, "' not registered for backend '").concat(this.backendName, "'"));
        ...
        (e.prototype.checkKernelForMemLeak = function (e, t, n) {
          ...
          if (i > 0)
            throw new Error(
              "Backend '".concat(this.backendName, "' has an internal memory leak ") +
        ...
        (e.prototype.runKernelFunc = function (e) {
          ...
          var c = ua(e) ? e.kernelName : null != this.state.activeScope ? this.state.activeScope.name : '';
          if (ua(e)) {
            var l = e.kernelName,
              h = e.inputs,
              f = e.attrs;
        ...
        (e.prototype.trackTensor = function (e, t) {
          ...
          var n = 0;
          'complex64' !== e.dtype && 'string' !== e.dtype && (n = e.size * M(e.dtype)),
              ...
              switch (o.label) {
                ...
                case 1:
                  (r.result = o.sent()),
                    ...
                    (o.label = 2);
                case 2:
                  o.trys.push([2, 8, 9, 10]), (a = i(this.state.activeProfile.kernels)), (c = a.next()), (o.label = 3);
                case 3:
                  return c.done ? [3, 7] : ((l = c.value), (h = l), [4, l.kernelTimeMs]);
                case 4:
        ...
        (e.prototype.gradients = function (e, t, n, r) {
          ...
          return this.tidy('backward', function () {
            var e,
              r,
              u = {};
            (u[o.id] = null == n ? ((e = o.shape), (r = U(y(e), 'float32')), da.makeTensor(r, e, 'float32')) : n),
              (function (e, t, n, r) {
                for (
                  var a = function (a) {
                      var o = t[a],
                      ...
                      var s = o.gradient(i),
                        u = function (t) {
                          if (!(t in s))
                            throw new Error(
                              'Cannot backprop through input '.concat(t, '. ') + 'Available gradients found: '.concat(Object.keys(s), '.'),
                            );
                          var a = n(function () {
                            return s[t]();
                          });
                          if ('float32' !== a.dtype)
                            throw new Error(
                              'Error in gradient for op '.concat(o.kernelName, '. The gradient of input ') +
                                ''.concat(t, " must have 'float32' dtype, but has '").concat(a.dtype, "'"),
                            );
                          var i = o.inputs[t];
                          if (!w(a.shape, i.shape))
                            throw new Error(
                              'Error in gradient for op '.concat(o.kernelName, '. The gradient of input ') +
                                "'".concat(t, "' has shape '").concat(a.shape, "', which does not match ") +
            ...
            return (
              0 === a.state.gradientDepth &&
                (a.state.activeTape.forEach(function (e) {
                  var t, n;
                  try {
                    for (var r = i(e.saved), a = r.next(); !a.done; a = r.next()) {
                      a.value.dispose();
                    }
                  } catch (e) {
                    t = { error: e };
        ...
        (e.prototype.customGrad = function (e) {
          ...
          return (
            ...
            function () {
              ...
              var i = function (t, a) {
                  return (
                    g((n = e.apply(void 0, u([], s(u(u([], s(r), !1), [a], !1)), !1))).value instanceof Vr, function () {
              ...
              return t.runKernelFunc({ forwardFunc: i, backwardsFunc: c, inputs: o });
            }
          );
        }),
        (e.prototype.readSync = function (e) {
        ...
        (e.prototype.reset = function () {
          for (var e in (this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), (this.state = new ca()), this.registry))
  ...
  function ya(e, t) {
    ...
    return Array.isArray(e) && J().getBool('TENSORLIKE_CHECK_SHAPE_CONSISTENCY') && ba(e, a, []), a;
  }
  function ba(e, t, n) {
    if (((n = n || []), Array.isArray(e) || Rr(e))) {
      g(t.length > 0, function () {
        ...
        g(e.length === t[0], function () {
          return (
            'Element arr['.concat(n.join(']['), '] should have ').concat(t[0], ' ') + 'elements, but has '.concat(e.length, ' elements')
          );
        });
      ...
      g(0 === t.length, function () {
        return (
          'Element arr['.concat(n.join(']['), '] is a primitive, ') + 'but should be an array/TypedArray of '.concat(t[0], ' elements')
        );
      });
  }
  function wa(e, t, n, r) {
    if ('string_or_numeric' !== e) {
      ...
      if (('numeric' !== e && e !== t) || ('numeric' === e && 'string' === t))
        throw new Error(
          "Argument '".concat(n, "' passed to '").concat(r, "' must ") + 'be '.concat(e, ' tensor, but got ').concat(t, ' tensor'),
        );
    }
  }
  function ka(e, t, n, r) {
    ...
    if (
      ...
      wa(r, a, t, n),
      null == e || (!Rr(e) && !Array.isArray(e) && 'number' != typeof e && 'boolean' != typeof e && 'string' != typeof e))
    ) {
  ...
  function Sa(e) {
    ...
    var a = function () {
      ...
      try {
        ...
        return K(a) && console.error('Cannot return a Promise inside of tidy.'), da.endScope(a), a;
      } catch (e) {
  ...
  var Aa = Sa({
    complex_: function (e, t) {
      var n = ka(e, 'real', 'complex'),
        r = ka(t, 'imag', 'complex');
      v(n.shape, r.shape, 'real and imag shapes, '.concat(n.shape, ' and ').concat(r.shape, ', ') + 'must match in call to tf.complex().');
      var a = { real: n, imag: r };
  ...
  function _a(e, t, n, r) {
    ...
    if (na(e) || ta(e)) {
      if ('float32' !== r && 'int32' !== r)
        throw new Error('Creating tensor from GPU data only supports ' + "'float32'|'int32' dtype, while the dtype is ".concat(r, '.'));
      return da.backend.createTensorFromGPUData(e, t || n, r);
    }
    if (!Rr(e) && !Array.isArray(e) && 'number' != typeof e && 'boolean' != typeof e && 'string' != typeof e)
      throw new Error(
    ...
    if (null != t) {
      ...
      for (var i = 0; i < n.length; ++i) {
        ...
        g(n[i] === t[i] || !u, function () {
          return (
            'Error creating a new Tensor. Inferred shape ' + '('.concat(n, ') does not match the provided ') + 'shape ('.concat(t, '). ')
          );
        });
      }
    }
    return Rr(e) || Array.isArray(e) || (e = [e]), (t = t || n), (e = 'string' !== r ? Nr(e, r) : Br(e, [], !0)), da.makeTensor(e, t, r);
  }
  function Ia(e, t, n) {
    return _a(e, t, ya(e, n), n);
  }
  var Na = { float32: 4, float16: 2, int32: 4, uint16: 2, uint8: 1, bool: 1, complex64: 8 },
    Ma = (function () {
      function e(e) {
        if (
          ((this.shards = []),
      ...
      return (
        ...
        (e.prototype.slice = function (e, t) {
          if ((void 0 === e && (e = 0), void 0 === t && (t = this.byteLength), 0 === this.shards.length)) return new ArrayBuffer(0);
          if (
            ((e = isNaN(Number(e)) ? 0 : e), (t = isNaN(Number(t)) ? 0 : t), (e = Math.max(0, e)), (t = Math.min(this.byteLength, t)) <= e)
          )
            return new ArrayBuffer(0);
          var n = this.findShardForByte(e);
          if (-1 === n) throw new Error('Could not find start shard for byte '.concat(e));
          for (var r = new ArrayBuffer(t - e), a = new Uint8Array(r), o = 0, i = n; i < this.shards.length; i++) {
            var s = this.shards[i],
              u = e + o - s.start,
              c = o,
    ...
    try {
      for (var c = i(t), l = c.next(); !l.done; l = c.next()) {
        var h = l.value,
          ...
          g = y(p),
          v = void 0;
        if ('quantization' in h) {
          var m = h.quantization;
          if ('uint8' === m.dtype || 'uint16' === m.dtype) {
            if (!('min' in m) || !('scale' in m))
              throw new Error(
                'Weight '.concat(h.name, ' with quantization ').concat(m.dtype, ' ') + "doesn't have corresponding metadata min and scale.",
              );
          } else {
            if ('float16' !== m.dtype)
              throw new Error(
                'Weight '.concat(h.name, ' has unknown ') +
                  'quantization dtype '.concat(m.dtype, '. ') +
                  "Supported quantization dtypes are: 'uint8', 'uint16', and 'float16'.",
              );
            if ('float32' !== d)
              throw new Error(
                'Weight '.concat(h.name, ' is quantized with ').concat(m.dtype, ' ') +
                  'which only supports weights of type float32 not '.concat(d, '.'),
              );
          }
          var b = Na[m.dtype],
            w = o.slice(u, u + g * b),
            k = 'uint8' === m.dtype ? new Uint8Array(w) : new Uint16Array(w);
          if ('float32' === d)
            if ('uint8' === m.dtype || 'uint16' === m.dtype) {
              v = new Float32Array(k.length);
              ...
              if ('float16' !== m.dtype)
                throw new Error('Unsupported quantization type '.concat(m.dtype, ' ') + 'for weight type float32.');
              void 0 === a && (a = Ua()), (v = a(k));
            }
          else {
            if ('int32' !== d) throw new Error("Unsupported dtype in weight '".concat(f, "': ").concat(d));
            if ('uint8' !== m.dtype && 'uint16' !== m.dtype)
              throw new Error('Unsupported quantization type '.concat(m.dtype, ' ') + 'for weight type int32.');
            v = new Int32Array(k.length);
            for (x = 0; x < k.length; x++) {
              E = k[x];
              v[x] = Math.round(E * m.scale + m.min);
            }
          }
          u += g * b;
        } else if ('string' === d) {
          ...
          v = [];
          for (x = 0; x < S; x++) {
            var A = new Uint32Array(o.slice(u, u + 4))[0];
            u += 4;
            var _ = new Uint8Array(o.slice(u, u + A));
            v.push(_), (u += A);
          }
        } else {
          var I = Na[d];
          w = o.slice(u, u + g * I);
          if ('float32' === d) v = new Float32Array(w);
          else if ('int32' === d) v = new Int32Array(w);
          else if ('bool' === d) v = new Uint8Array(w);
          else {
            if ('complex64' !== d) throw new Error("Unsupported dtype in weight '".concat(f, "': ").concat(d));
            v = new Float32Array(w);
            var N = new Float32Array(v.length / 2),
              M = new Float32Array(v.length / 2);
            for (x = 0; x < N.length; x++) (N[x] = v[2 * x]), (M[x] = v[2 * x + 1]);
            var T = Ia(N, p, 'float32'),
              D = Ia(M, p, 'float32');
            (s[f] = Aa(T, D)), T.dispose(), D.dispose();
          }
          u += g * I;
        }
        'complex64' !== d && (s[f] = Ia(v, p, d));
      }
    } catch (e) {
      n = { error: e };
    } finally {
  ...
  function Da(e) {
    ...
    e.forEach(function (e) {
      if (
        ...
        throw new Error('Unsupported TypedArray subtype: '.concat(e.constructor.name));
    });
  ...
  var Ra = 'undefined' != typeof Buffer && ('undefined' == typeof Blob || 'undefined' == typeof atob || 'undefined' == typeof btoa);
  function Ba(e) {
    return Ra ? Buffer.byteLength(e, 'utf8') : new Blob([e]).size;
  }
  function Fa(e) {
  ...
  function Pa(e, t, n) {
    var r = { modelTopology: e.modelTopology, format: e.format, generatedBy: e.generatedBy, convertedBy: e.convertedBy };
  ...
  function Oa(e, t) {
    return a(this, void 0, void 0, function () {
      ...
      return o(this, function (o) {
        switch (o.label) {
          case 0:
            return null == e.weightsManifest ? [3, 2] : [4, t(e.weightsManifest)];
          case 1:
            (a = s.apply(void 0, [o.sent(), 2])), (n = a[0]), (r = a[1]), (o.label = 2);
          case 2:
            return [2, Pa(e, n, r)];
        }
      });
  ...
  function La(e) {
    ...
    return {
      ...
      modelTopologyBytes: null == e.modelTopology ? 0 : Ba(JSON.stringify(e.modelTopology)),
      weightSpecsBytes: null == e.weightSpecs ? 0 : Ba(JSON.stringify(e.weightSpecs)),
  ...
  var Wa = (function () {
      ...
      return (
        ...
        (e.getHandlers = function (t, n, r) {
          var a = [];
          return (
            ('load' === n ? e.getInstance().loadRouters : e.getInstance().saveRouters).forEach(function (e) {
              var n = e(t, r);
              null !== n && a.push(n);
            }),
            a
  ...
  function Ha(e) {
    var t = e.result;
    t.createObjectStore(Ka, { keyPath: 'modelPath' }), t.createObjectStore(qa, { keyPath: 'modelPath' });
  }
  var ja = (function () {
    function e(e) {
      if (((this.indexedDB = Va()), null == e || !e)) throw new Error('For IndexedDB, modelPath must not be null, undefined or empty.');
      this.modelPath = e;
    }
    return (
        ...
        return new Promise(function (e, r) {
          ...
          (a.onupgradeneeded = function () {
            ...
            (a.onsuccess = function () {
              var o = a.result;
              if (null == t) {
                var i = o.transaction(Ka, 'readonly'),
                  s = i.objectStore(Ka).get(n.modelPath);
                (s.onsuccess = function () {
                  if (null == s.result)
                    return o.close(), r(new Error("Cannot find model with path '".concat(n.modelPath, "' ") + 'in IndexedDB.'));
                ...
                (u.onsuccess = function () {
                  var a,
                    i = (c = o.transaction(Ka, 'readwrite')).objectStore(Ka);
                  try {
                    a = i.put({ modelPath: n.modelPath, modelArtifacts: t, modelArtifactsInfo: l });
                  } catch (e) {
                    return r(e);
                  }
                  (a.onsuccess = function () {
  ...
  ja.URL_SCHEME = 'indexeddb://';
  var Za = function (e) {
    return J().getBool('IS_BROWSER') && !Array.isArray(e) && e.startsWith(ja.URL_SCHEME)
      ? ((t = e.slice(ja.URL_SCHEME.length)), new ja(t))
      : null;
    var t;
  };
  Wa.registerSaveRouter(Za), Wa.registerLoadRouter(Za);
  var Ja = (function () {
      function e() {
        this.indexedDB = Va();
      }
                    ...
                    (r.onsuccess = function () {
                      ...
                      (o.onsuccess = function () {
                        var e,
                          ...
                          r = {};
                        try {
                          for (var a = i(o.result), s = a.next(); !s.done; s = a.next()) {
                            var u = s.value;
        ...
        (e.prototype.removeModel = function (e) {
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (n) {
              var r;
              return (
                (e = (r = e).startsWith(ja.URL_SCHEME) ? r.slice(ja.URL_SCHEME.length) : r),
                [
                  2,
                  new Promise(function (n, r) {
                    var a = t.indexedDB.open(Ga, 1);
                    (a.onupgradeneeded = function () {
                      return Ha(a);
                    }),
                      (a.onsuccess = function () {
                        ...
                        (u.onsuccess = function () {
                          if (null == u.result)
                            return o.close(), r(new Error("Cannot find model with path '".concat(e, "' ") + 'in IndexedDB.'));
                          var a = s.delete(e),
                            i = function () {
                              var a = (t = o.transaction(Ka, 'readwrite')).objectStore(Ka).delete(e);
                              (a.onsuccess = function () {
  ...
  function ro(e) {
    return {
      info: [Xa, e, Qa].join(Ya),
      topology: [Xa, e, $a].join(Ya),
      weightSpecs: [Xa, e, eo].join(Ya),
      weightData: [Xa, e, to].join(Ya),
      modelMetadata: [Xa, e, no].join(Ya),
    };
  }
  function ao(e) {
    var t, n;
  ...
  var io = (function () {
    function e(e) {
      if (!J().getBool('IS_BROWSER') || 'undefined' == typeof window || 'undefined' == typeof window.localStorage)
        throw new Error('The current environment does not support local storage.');
      if (((this.LS = window.localStorage), null == e || !e))
        throw new Error('For local storage, modelPath must not be null, undefined or empty.');
      (this.modelPath = e), (this.keys = ro(this.modelPath));
    }
    return (
      (e.prototype.save = function (e) {
        return a(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            if (e.modelTopology instanceof ArrayBuffer)
              throw new Error('BrowserLocalStorage.save() does not support saving model topology in binary formats yet.');
            (t = JSON.stringify(e.modelTopology)), (n = JSON.stringify(e.weightSpecs)), (r = La(e)), (a = Ma.join(e.weightData));
            try {
              return (
                ...
                this.LS.setItem(
                  ...
                  (function (e) {
                    if (Ra) return Buffer.from(e).toString('base64');
              ...
              throw (
                (ao(this.keys),
                new Error(
                  "Failed to save model '".concat(this.modelPath, "' to local storage: ") +
      ...
      (e.prototype.load = function () {
        return a(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            ...
            if (((t = {}), null == (n = JSON.parse(this.LS.getItem(this.keys.topology)))))
              throw new Error("In local storage, the topology of model '".concat(this.modelPath, "' ") + 'is missing.');
            if (((t.modelTopology = n), null == (r = JSON.parse(this.LS.getItem(this.keys.weightSpecs)))))
            ...
            if (
              ...
              null != (a = this.LS.getItem(this.keys.modelMetadata)) &&
                ...
                null != i.initializerSignature && (t.initializerSignature = i.initializerSignature),
  ...
  var so = function (e) {
    return J().getBool('IS_BROWSER') && !Array.isArray(e) && e.startsWith(io.URL_SCHEME)
      ? ((t = e.slice(io.URL_SCHEME.length)), new io(t))
      : null;
    var t;
  };
  Wa.registerSaveRouter(so), Wa.registerLoadRouter(so);
  var uo = (function () {
      function e() {
        g(J().getBool('IS_BROWSER'), function () {
          return 'Current environment is not a web browser';
        }),
          g('undefined' == typeof window || 'undefined' != typeof window.localStorage, function () {
      ...
      return (
        (e.prototype.listModels = function () {
          return a(this, void 0, void 0, function () {
            var e, t, n, r, a, i;
            return o(this, function (o) {
              for (e = {}, t = Xa + Ya, n = Ya + Qa, r = 0; r < this.LS.length; ++r)
                (a = this.LS.key(r)).startsWith(t) && a.endsWith(n) && ((i = oo(a)), (e[i] = JSON.parse(this.LS.getItem(a))));
              return [2, e];
            });
          });
        }),
        (e.prototype.removeModel = function (e) {
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (r) {
              var a;
              if (
                ((e = (a = e).startsWith(io.URL_SCHEME) ? a.slice(io.URL_SCHEME.length) : a), (t = ro(e)), null == this.LS.getItem(t.info))
              )
                throw new Error("Cannot find model at path '".concat(e, "'"));
              return (n = JSON.parse(this.LS.getItem(t.info))), ao(t), [2, n];
            });
          });
        }),
        e
      ...
      return (
        ...
        (e.registerManager = function (t, n) {
          g(null != t, function () {
            ...
            t.endsWith(co) && (t = t.slice(0, t.indexOf(co))),
            g(t.length > 0, function () {
  ...
  function ho(e) {
    if (-1 === e.indexOf(co))
      throw new Error('The url string provided does not contain a scheme. Supported schemes are: ' + ''.concat(lo.getSchemes().join(',')));
    return { scheme: e.split(co)[0], path: e.split(co)[1] };
  }
  function fo(e, t, n) {
    return (
      void 0 === n && (n = !1),
          ...
          switch (o.label) {
            case 0:
              return (
                ...
                g((r = Wa.getLoadHandlers(e)).length > 0, function () {
                  return 'Copying failed because no load handler is found for source URL '.concat(e, '.');
                }),
                g(r.length < 2, function () {
                  return 'Copying failed because more than one ('.concat(r.length, ') ') + 'load handlers for source URL '.concat(e, '.');
                }),
                (a = r[0]),
                g((i = Wa.getSaveHandlers(t)).length > 0, function () {
                  return 'Copying failed because no save handler is found for destination ' + 'URL '.concat(t, '.');
                }),
                g(i.length < 2, function () {
                  return (
                    'Copying failed because more than one ('.concat(r.length, ') ') + 'save handlers for destination URL '.concat(t, '.')
                  );
                }),
                (s = i[0]),
                (u = ho(e).scheme),
            ...
            case 1:
              return (h = o.sent()), n && l ? [4, lo.getManager(u).removeModel(c)] : [3, 3];
            case 2:
              o.sent(), (o.label = 3);
            case 3:
              return [4, s.save(h)];
            case 4:
              return (f = o.sent()), !n || l ? [3, 6] : [4, lo.getManager(u).removeModel(c)];
            case 5:
              o.sent(), (o.label = 6);
            case 6:
  ...
  var po = (function () {
    ...
    return (
      ...
      (e.prototype.setTimeoutCustom = function (e, t) {
        var n = this;
        'undefined' != typeof window && J().getBool('USE_SETTIMEOUTCUSTOM')
          ? (this.functionRefs.push(e),
            setTimeout(function () {
              window.postMessage({ name: n.messageName, index: n.functionRefs.length - 1 }, '*');
            }, t),
              ...
              window.addEventListener(
                ...
                function (e) {
                  e.source === window &&
                    ...
                    n.handledMessageCount === n.functionRefs.length && ((n.functionRefs = []), (n.handledMessageCount = 0)));
                },
                !0,
              )))
          : setTimeout(e, t);
  ...
  if (J().get('IS_BROWSER')) {
    J().setPlatform('browser', new po());
    try {
      lo.registerManager(io.URL_SCHEME, new uo());
    } catch (e) {}
    try {
      lo.registerManager(ja.URL_SCHEME, new Ja());
    } catch (e) {}
  }
  var go,
    vo = function () {
    ...
    mo = (function () {
      ...
      return (
        (e.prototype.fetch = function (e, t) {
          return null != J().global.fetch ? J().global.fetch(e, t) : (null == go && (go = vo()), go(e, t));
        }),
        (e.prototype.now = function () {
  ...
  J().get('IS_NODE') && !J().get('IS_BROWSER') && J().setPlatform('node', new mo());
  var bo = Sa({
    cast_: function (e, t) {
      var n = ka(e, 'x', 'cast');
  ...
  ha(), (qr = { buffer: yo, cast: bo, clone: wo, print: ko });
  var Ao = Sa({
    add_: function (e, t) {
      var n,
        r = ka(e, 'a', 'add'),
  ...
  var Io = Sa({
    div_: function (e, t) {
      var n,
        r = ka(e, 'a', 'div'),
        a = ka(t, 'b', 'div');
      if (((r = (n = s(ra(r, a), 2))[0]), (a = n[1]), 'int32' === r.dtype && 'int32' === a.dtype)) return _o(r, a);
      var o = { a: r, b: a };
  ...
  var Ro = Sa({
    addN_: function (e) {
      ...
      t.forEach(function (e) {
        ...
        t.forEach(function (e) {
          if (!w(e.shape, n.shape)) throw new Error('All tensors passed to tf.addN() must have the same shape');
        });
      var r = t;
  ...
  function Go(e, t, n, r, a, o, i) {
    ...
    return Ko(e, u, n, r, a, o, !1, i);
  }
  function Ko(e, t, n, r, a, o, i, u) {
    var c, l;
    ...
    var v,
      ...
      M = (function (e, t, n, r, a, o, i, s, u) {
        var c, l, h;
        if ('number' == typeof e) {
          c = { top: e, bottom: e, left: e, right: e, type: 0 === e ? 'VALID' : 'NUMBER' };
          ...
          c = { top: (g = Math.floor(d / 2)), bottom: (v = d - g), left: (m = Math.floor(p / 2)), right: (y = p - m), type: 'SAME' };
        } else if ('valid' === e)
          (c = { top: 0, bottom: 0, left: 0, right: 0, type: 'VALID' }), (l = Math.ceil((t - o + 1) / r)), (h = Math.ceil((n - i + 1) / a));
        else {
      ...
      B = i ? w * g : w;
    return (
      'channelsFirst' === u ? (v = [f, B, D, R]) : 'channelsLast' === u && (v = [f, D, R, B]),
      {
        batchSize: f,
        dataFormat: u,
        inHeight: d,
  ...
  function qo(e, t, n, r, a, o, i, u) {
    ...
    var m,
      ...
      F = (function (e, t, n, r, a, o, i, s, u, c, l) {
        ...
        if ('number' == typeof e) {
          ...
          var g = (function (e, t, n, r, a, o) {
            null == a && (a = Vo(e, t[0], r[0]));
            for (var i = [0, 0, 0, n], s = 0; s < 3; s++) e[s] + 2 * a >= t[s] && (i[s] = Jo((e[s] - t[s] + 2 * a) / r[s] + 1, o));
            return i;
          ...
          var v = ((f = Math.ceil(t / a)) - 1) * a + s - t,
            ...
            x = m - k,
            E = Math.floor(y / 2);
          h = { top: k, bottom: x, left: E, right: y - E, front: b, back: w, type: 'SAME' };
        }
      ...
      z = o ? x * v : x;
    return (
      'channelsFirst' === i ? (m = [f, z, P, O, L]) : 'channelsLast' === i && (m = [f, P, O, L, z]),
      {
        batchSize: f,
        dataFormat: i,
        inDepth: d,
  ...
  function ei(e, t, n) {
    if (null != n) {
      if ('string' == typeof t)
        throw Error(
          'Error in '.concat(e, ': pad must be an integer when using ') + 'dimRoundingMode '.concat(n, ' but got pad ').concat(t, '.'),
        );
      if ('number' == typeof t)
        g(k(t), function () {
          return (
        ...
        if ('object' != typeof t) throw Error('Error in '.concat(e, ': Unknown padding parameter: ').concat(t));
        t.forEach(function (t) {
          t.forEach(function (t) {
            g(k(t), function () {
              return (
  ...
  var ni = Sa({
    avgPool_: function (e, t, n, r, a) {
      ...
      var i = o,
        s = !1;
      3 === o.rank && ((s = !0), (i = ti(o, [1, o.shape[0], o.shape[1], o.shape[2]]))),
        g(4 === i.rank, function () {
      ...
      return (l = bo(l, o.dtype)), s ? ti(l, [l.shape[1], l.shape[2], l.shape[3]]) : l;
    },
  });
  var ri = Sa({
    avgPool3d_: function (e, t, n, r, a, o) {
      ...
      var i = ka(e, 'x', 'avgPool3d', 'float32'),
        s = i,
        u = !1;
      4 === i.rank && ((u = !0), (s = ti(i, [1, i.shape[0], i.shape[1], i.shape[2], i.shape[3]]))),
        g(5 === s.rank, function () {
        ...
        g(('number' == typeof n && n > 0) || (Array.isArray(n) && n[0] > 0 && n[1] > 0 && n[2] > 0), function () {
          return "Error in avgPool3d: Stride must be > 0, but got '".concat(n, "'");
        }),
        ei('avgPool3d', r, a);
      var c = { x: s },
        l = { filterSize: t, strides: n, pad: r, dimRoundingMode: a, dataFormat: o },
        h = da.runKernel(le, c, l);
      return (h = bo(h, s.dtype)), u ? ti(h, [h.shape[1], h.shape[2], h.shape[3], h.shape[4]]) : h;
    },
  });
  var ai = Sa({
  ...
  var ci = Sa({
    basicLSTMCell_: function (e, t, n, r, a, o) {
      var i = ka(e, 'forgetBias', 'basicLSTMCell'),
        ...
        w = si(p, [0, 2 * v], m),
        k = si(p, [0, 3 * v], m),
        x = Ao(No(ii(y), ui(b)), No(l, ii(Ao(i, w))));
      return [x, No(ui(x), ii(k))];
    },
  });
  var li = Sa({
    batchToSpaceND_: function (e, t, n) {
      ...
      g(r.rank >= 1 + t.length, function () {
        ...
        g(r.shape[0] % a == 0, function () {
          return (
            'input tensor batch is '.concat(r.shape[0], ' but is not divisible by the product of ') +
            'the elements of blockShape '.concat(t.join(' * '), ' === ').concat(a)
          );
        });
      var o = { x: r },
    ...
    batchNorm_: function (e, t, n, r, a, o) {
      ...
      var h = (function (e) {
          return 0 === e.rank || 1 === e.rank
            ? ti(e, [1, 1, 1, e.size])
            : 2 === e.rank
            ? ti(e, [1, 1, e.shape[0], e.shape[1]])
            : 3 === e.rank
            ? ti(e, [1, e.shape[0], e.shape[1], e.shape[2]])
            : e;
        })(u),
        f = { x: h, scale: i, offset: s, mean: c, variance: l },
        d = { varianceEpsilon: o },
        p = da.runKernel(Ze, f, d);
      return ti(p, u.shape);
    },
  });
  var fi = Sa({
      ...
      return (
        ...
        null != i &&
          g(2 === i.rank || 1 === i.rank, function () {
            return 'Error in batchNorm2D: scale must be rank 2 or rank 1 ' + 'but got rank '.concat(i.rank, '.');
          }),
        null != s &&
      ...
      return (
        ...
        null != i &&
          g(3 === i.rank || 1 === i.rank, function () {
            return 'Error in batchNorm3D: scale must be rank 3 or rank 1 ' + 'but got rank '.concat(i.rank, '.');
          }),
        null != s &&
      ...
      return (
        ...
        null != i &&
          g(4 === i.rank || 1 === i.rank, function () {
            return 'Error in batchNorm4D: scale must be rank 4 or rank 1 ' + 'but got rank '.concat(i.rank, '.');
          }),
        null != s &&
      ...
      g('int32' === r.dtype, function () {
        ...
        g(a.size === r.size || 0 === a.size, function () {
          return (
            ...
            '0-length, but got input shape: '.concat(r.shape, ', weights shape: ') +
            ''.concat(a.shape, '.')
          );
        });
      var o = { x: r, weights: a },
  ...
  var vi = Sa({
    bitwiseAnd_: function (e, t) {
      ...
      if (!w(n.shape, r.shape))
        throw new Error('BitwiseAnd: Tensors must have the same shape. x: '.concat(n.shape, ', y: ').concat(r.shape));
      if ('int32' !== n.dtype || 'int32' !== r.dtype)
        throw new Error(
          "BitwiseAnd: Only supports 'int32' values in tensor, found type of x: ".concat(n.dtype, ' and type of y: ').concat(r.dtype),
        );
      var a = { a: n, b: r };
  ...
  var yi = Sa({
    broadcastTo_: function (e, t) {
      var n = ka(e, 'broadcastTo', 'x'),
        r = n.shape;
      if ((G(t), t.length < n.rank)) throw new Error('broadcastTo(): shape.length='.concat(t.length, ' < input.rank=').concat(n.rank, '.'));
      if (t.length > n.rank) {
  ...
  var _i = Sa({
    conv2d_: function (e, t, n, r, a, o, i) {
      ...
      var s = ka(e, 'x', 'conv2d', 'float32'),
        ...
        c = s,
        l = !1;
      3 === s.rank && ((l = !0), (c = ti(s, [1, s.shape[0], s.shape[1], s.shape[2]]))),
        g(4 === c.rank, function () {
      ...
      var f = { x: c, filter: u },
        d = { strides: n, pad: r, dataFormat: a, dilations: o, dimRoundingMode: i },
        p = da.runKernel(xe, f, d);
      return l ? ti(p, [p.shape[1], p.shape[2], p.shape[3]]) : p;
    },
  });
  var Ii = Sa({
    conv1d_: function (e, t, n, r, a, o, i) {
      ...
      var s = ka(e, 'x', 'conv1d'),
        ...
        c = s,
        l = !1;
      2 === s.rank && ((l = !0), (c = ti(s, [1, s.shape[0], s.shape[1]]))),
        g(3 === c.rank, function () {
        ...
        g(c.shape[2] === u.shape[1], function () {
          return (
            'Error in conv1d: depth of input ('.concat(c.shape[2], ') must match ') + 'input depth for filter '.concat(u.shape[1], '.')
          );
        }),
        g(Xo(n, o), function () {
      ...
      var h = ti(u, [1, u.shape[0], u.shape[1], u.shape[2]]),
        f = ti(c, [c.shape[0], 1, c.shape[1], c.shape[2]]),
        d = _i(f, h, [1, n], r, 'NHWC', [1, o], i);
      return ti(d, l ? [d.shape[2], d.shape[3]] : [d.shape[0], d.shape[2], d.shape[3]]);
    },
  });
  var Ni = Sa({
    conv2DBackpropInput_: function (e, t, n, r, a, o, i) {
      ...
      var s = e,
        u = t,
        c = !1;
      3 === t.rank && ((c = !0), (u = ti(t, [1, t.shape[0], t.shape[1], t.shape[2]])), (s = [1, e[0], e[1], e[2]])),
      ...
      g(l === n.shape[2], function () {
        ...
        g(h === n.shape[3], function () {
          return (
            'Error in conv2dDerInput: depth of output ('.concat(h, ') must ') + 'match output depth for filter '.concat(n.shape[3], '.')
          );
        }),
        ei('conv2dDerInput', a, i);
      var f = { dy: u, filter: n },
        d = { strides: r, pad: a, dataFormat: o, dimRoundingMode: i, inputShape: s },
        p = da.runKernel(Se, f, d);
      return c ? ti(p, [p.shape[1], p.shape[2], p.shape[3]]) : p;
    },
  });
  var Mi = Sa({
  ...
  var Ti = Sa({
    conv3d_: function (e, t, n, r, a, o) {
      ...
      var i = ka(e, 'x', 'conv3d'),
        ...
        u = i,
        c = !1;
      4 === i.rank && ((c = !0), (u = ti(i, [1, i.shape[0], i.shape[1], i.shape[2], i.shape[3]]))),
        g(5 === u.rank, function () {
        ...
        g(u.shape[4] === s.shape[3], function () {
          return (
            'Error in conv3d: depth of input ('.concat(u.shape[4], ') must match ') + 'input depth for filter '.concat(s.shape[3], '.')
          );
        }),
        g(Xo(n, o), function () {
      ...
      return c ? ti(f, [f.shape[1], f.shape[2], f.shape[3], f.shape[4]]) : f;
    },
  });
  var Di = Sa({
    conv3DBackpropInput_: function (e, t, n, r, a) {
      ...
      var o = e,
        i = t,
        s = !1;
      4 === t.rank && ((s = !0), (i = ti(t, [1, t.shape[0], t.shape[1], t.shape[2], t.shape[3]])), (o = [1, e[0], e[1], e[2], e[3]]));
      var u = o[4],
        c = i.shape[4];
      g(5 === o.length, function () {
        ...
        g(c === n.shape[4], function () {
          return (
            'Error in conv3dDerInput: depth of output ('.concat(c, ') must ') + 'match output depth for filter '.concat(n.shape[4], '.')
          );
        });
      var l = { dy: i, filter: n },
        h = { pad: a, strides: r, inputShape: o },
        f = da.runKernel(_e, l, h);
      return s ? ti(f, [f.shape[1], f.shape[2], f.shape[3], f.shape[4]]) : f;
    },
  });
  var Ri = Sa({
  ...
  var Wi = Sa({
    dilation2d_: function (e, t, n, r, a, o) {
      ...
      var u = i,
        c = !1;
      3 === i.rank && ((u = ti(i, [1, i.shape[0], i.shape[1], i.shape[2]])), (c = !0)),
      ...
      return c ? ti(f, [f.shape[1], f.shape[2], f.shape[3]]) : f;
    },
  });
  function Gi(e, t) {
  ...
  var Vi = { __proto__: null, assertAndGetBroadcastShape: qi, getBroadcastDims: Gi, getReductionAxes: Ki };
  var Hi = Sa({
    equal_: function (e, t) {
      var n,
        r = ka(e, 'a', 'equal', 'string_or_numeric'),
        a = ka(t, 'b', 'equal', 'string_or_numeric');
      (r = (n = s(ra(r, a), 2))[0]), (a = n[1]), qi(r.shape, a.shape);
      var o = { a: r, b: a };
  ...
  var ji = Sa({
    where_: function (e, t, n) {
      var r = ka(t, 'a', 'where'),
        ...
        i = qi(qi(o.shape, r.shape), a.shape),
        s = { condition: yi(o, i), t: yi(r, i), e: yi(a, i) };
      return da.runKernel(Jt, s);
    },
  });
  var Zi = Sa({
  ...
  var Yi = Sa({
    dot_: function (e, t) {
      ...
      if (1 === n.rank && 2 === r.rank) {
        (i = ti(n, [1, -1])), (s = ti(r, [r.shape[0], r.shape[1]])), (u = oi(i, s));
        return ti(u, [u.size]);
      }
      ...
      return (s = ti(r, [r.shape[0], r.shape[1]])), (u = oi(n, s));
    },
  });
  var Xi = Sa({
    einsum_: function (e) {
  ...
  var $i = Sa({
    ensureShape_: function (e, t) {
      ...
      if (!b(n.shape, t))
        throw new Error('EnsureShape: Shape of tensor '.concat(n.shape, ' is not compatible with expected shape ').concat(t));
      return e;
    },
  });
  var es = Sa({
  ...
  function ns(e, t, n) {
    for (var r = e.length + t.length, a = [], o = 0, i = 0, s = 0; s < r; s++) -1 === n.indexOf(s) ? a.push(e[o++]) : a.push(t[i++]);
    return a;
  }
  function rs(e, t) {
    return ns(
  ...
  function hs(e, t, n) {
    if ((void 0 === n && (n = null), 0 === e.rank)) return Mo(e);
    if (1 !== e.rank && null === n) return hs(ti(e, [-1]), t, n);
    if (1 === e.rank || 'number' == typeof n || (Array.isArray(n) && 1 === n.length)) {
      if (1 === t) return ls(Mo(e), n);
      if (t === 1 / 0) return as(Mo(e), n);
      if (t === -1 / 0) return os(Mo(e), n);
      if ('euclidean' === t || 2 === t) return us(ls(is(Mo(e), ss(2, 'int32')), n));
      throw new Error('Error in norm: invalid ord value: '.concat(t));
    }
    if (Array.isArray(n) && 2 === n.length) {
      if (1 === t) return as(ls(Mo(e), n[0]), n[1] - 1);
      if (t === 1 / 0) return as(ls(Mo(e), n[1]), n[0]);
      if (t === -1 / 0) return os(ls(Mo(e), n[1]), n[0]);
      if ('fro' === t || 'euclidean' === t) return us(ls(cs(e), n));
      throw new Error('Error in norm: invalid ord value: '.concat(t));
    }
  ...
  var ds = Sa({
    euclideanNorm_: function (e, t, n) {
      return void 0 === t && (t = null), void 0 === n && (n = !1), fs(e, 'euclidean', t, n);
    },
  });
  var ps = Sa({
    exp_: function (e) {
  ...
  var ys = Sa({
    eye_: function (e, t, n, r) {
      ...
      for (var a = yo([e, t], r), o = e <= t ? e : t, i = 0; i < o; ++i) a.set(1, i, i);
      var s = ti(a.toTensor(), [e, t]);
      if (null == n) return s;
      if (1 === n.length) return ms(gs(s, 0), [n[0], 1, 1]);
      if (2 === n.length) return ms(gs(gs(s, 0), 0), [n[0], n[1], 1, 1]);
      if (3 === n.length) return ms(gs(gs(gs(s, 0), 0), 0), [n[0], n[1], n[2], 1, 1]);
  ...
  var ws = Sa({
    gather_: function (e, t, n, r) {
      ...
      var a = { x: ka(e, 'x', 'gather'), indices: ka(t, 'indices', 'gather', 'int32') },
        o = { axis: n, batchDims: r };
      return da.runKernel(Je, a, o);
    },
  });
  var ks = Sa({
  ...
  var Ts = Sa({
    localResponseNormalization_: function (e, t, n, r, a) {
      ...
      return s ? ti(l, [l.shape[1], l.shape[2], l.shape[3]]) : l;
    },
  });
  var Ds = Sa({
    log_: function (e) {
  ...
  function Bs(e, t) {
    ...
    var n = null != t;
    if (!n) for (var r in ((t = []), da.registeredVariables)) t.push(da.registeredVariables[r]);
    var a = n
        ? t.filter(function (e) {
            return !e.trainable;
          })
  ...
  var Us = Sa({
    logSoftmax_: function (e, t) {
      ...
      if ((-1 === t && (t = n.rank - 1), t !== n.rank - 1))
        throw Error(
          'Log Softmax along a non-last dimension is not yet supported. ' + 'Logits was rank '.concat(n.rank, ' and axis was ').concat(t),
        );
      var r = Fs(function (e, n) {
        var r = as(e, t, !0),
          a = zs(e, r),
          o = zs(bo(a, 'float32'), Ds(ls(ps(a), t, !0)));
        n([o]);
        return {
          value: o,
  ...
  var Vs = Sa({
      logicalXor_: function (e, t) {
        ...
        return qi(n.shape, r.shape), Gs(qs(e, t), Ks(Gs(e, t)));
      },
    }),
    Hs = 2147483648;
  var js = Sa({
    searchSorted_: function (e, t, n) {
      ...
      if (y(u.shape) >= Hs) throw new Error('values tensor size must less than '.concat(Hs));
      if (s.shape[1] >= Hs)
        throw new Error('trailing dim_size must less than '.concat(Hs, ' for int32 output type, was ').concat(s.shape[1]));
      var c = { sortedSequence: s, values: u },
        l = { side: n };
      return da.runKernel(Zt, c, l);
    },
  });
  var Zs = Sa({
  ...
  var Js = Sa({
    maxPool3d_: function (e, t, n, r, a, o) {
      ...
      return u ? ti(h, [h.shape[1], h.shape[2], h.shape[3], h.shape[4]]) : h;
    },
  });
  var Ys = Sa({
  ...
  var Xs = Sa({
    maximum_: function (e, t) {
      var n,
        r = ka(e, 'a', 'maximum'),
        a = ka(t, 'b', 'maximum');
      (r = (n = s(ra(r, a), 2))[0]), (a = n[1]), 'bool' === r.dtype && ((r = bo(r, 'int32')), (a = bo(a, 'int32'))), qi(r.shape, a.shape);
      var o = { a: r, b: a };
        ...
        var a = 'reflect' === n ? 1 : 0,
          o = function (e) {
            g(2 === t[e].length, function () {
              ...
              g(t[e][0] >= 0 && t[e][0] <= r.shape[e] - a && t[e][1] >= 0 && t[e][1] <= r.shape[e] - a, function () {
                return (
                  'Padding in dimension '.concat(e, ' cannot be greater than or equal ') +
                  'to '.concat(r.shape[e] - a, ' or less than 0 for input of ') +
  ...
  var au = Sa({
    moments_: function (e, t, n) {
      ...
      var r = E(t, (e = ka(e, 'x', 'moments')).shape),
        ...
        o = a.shape;
      n || (o = rs(a.shape, r));
      var i = cs(zs(bo(e, 'float32'), ti(a, o)));
      return { mean: a, variance: Qs(i, r, n) };
    },
  });
  var ou = Sa({
    multiRNNCell_: function (e, t, n, r) {
      for (
        var a = ka(t, 'data', 'multiRNNCell'), o = xa(n, 'c', 'multiRNNCell'), i = xa(r, 'h', 'multiRNNCell'), s = a, u = [], c = 0;
        c < e.length;
        c++
      ) {
        var l = e[c](s, o[c], i[c]);
  ...
  var iu = Sa({
    multinomial_: function (e, t, n, r) {
      ...
      var a = ka(e, 'logits', 'multinomial'),
        o = a.size,
        i = a.rank;
      if (o < 2) throw new Error('Error in multinomial: you need at least 2 outcomes, but got ' + ''.concat(o, '.'));
      if (i > 2) throw new Error('Rank of probabilities must be 1 or 2, but is '.concat(i));
      n = n || Math.random();
      var s = { logits: 1 === i ? ti(a, [1, -1]) : a },
        u = { numSamples: t, seed: n, normalized: r },
        c = da.runKernel(wt, s, u);
      return 1 === i ? ti(c, [c.size]) : c;
    },
  });
  var su = Sa({
  ...
  var uu = Sa({
    oneHot_: function (e, t, n, r, a) {
      if ((void 0 === n && (n = 1), void 0 === r && (r = 0), void 0 === a && (a = 'int32'), t < 2))
  ...
  var du = Sa({
    pad2d_: function (e, t, n) {
      return (
        void 0 === n && (n = 0),
        g(2 === t.length && 2 === t[0].length && 2 === t[1].length, function () {
          return 'Invalid number of paddings. Must be length of 2 each.';
        }),
        hu(e, t, n)
      );
  ...
  var pu = Sa({
    pad3d_: function (e, t, n) {
      return (
        void 0 === n && (n = 0),
        g(3 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length, function () {
          return 'Invalid number of paddings. Must be length of 2 each.';
        }),
        hu(e, t, n)
      );
  ...
  var gu = Sa({
    pad4d_: function (e, t, n) {
      return (
        void 0 === n && (n = 0),
        g(4 === t.length && 2 === t[0].length && 2 === t[1].length && 2 === t[2].length && 2 === t[3].length, function () {
          return 'Invalid number of paddings. Must be length of 2 each.';
        }),
        hu(e, t, n)
      );
  ...
  var mu = Sa({
    pool_: function (e, t, n, r, a, o, i) {
      ...
      var p = 1 === d[0] && 1 === d[1],
        ...
        x = p ? k : li(k, d, y);
      return l ? ti(x, [x.shape[1], x.shape[2], x.shape[3]]) : x;
    },
  });
  var yu = Sa({
    prelu_: function (e, t) {
  ...
  var wu = Sa({
    raggedGather_: function (e, t, n, r) {
      ...
      return { outputNestedSplits: i.slice(0, i.length - 1), outputDenseValues: i[i.length - 1] };
    },
  });
  var ku = Sa({
    raggedRange_: function (e, t, n) {
      var r = ka(e, 'starts', 'raggedRange'),
        a = { starts: r, limits: ka(t, 'limits', 'raggedRange', r.dtype), deltas: ka(n, 'deltas', 'raggedRange', r.dtype) },
        o = da.runKernel(Bt, a);
        ...
        (t.next = function () {
          ...
          (function (e, t) {
            var n,
              ...
              s = [],
              u = 128;
            for (t === (0 | t) ? ((r = t), (t = null)) : ((t += '\0'), (r = 0), (u = Math.max(u, t.length))), a = 0, o = -32; o < u; ++o)
              t && (r ^= t.charCodeAt((o + 32) % t.length)),
                ...
                (r ^= r << 4),
                (r ^= r >>> 13),
                o >= 0 && ((i = (i + 1640531527) | 0), (a = 0 == (n = s[127 & o] ^= r + i) ? a + 1 : 0));
  ...
  !(function (e) {
    !(function (t, n, r) {
              ...
              (c = 1 == c ? { entropy: !0 } : c || {}).entropy
                ...
                ? (function () {
                    try {
                      var e;
                      return (
                        a && (e = a.randomBytes) ? (e = e(o)) : ((e = new Uint8Array(o)), (t.crypto || t.msCrypto).getRandomValues(e)), g(e)
                      );
                    } catch (e) {
                      var r = t.navigator,
                        i = r && r.plugins;
      ...
      function h(e) {
        ...
        (r.g = function (e) {
          for (var t, n = 0, a = r.i, i = r.j, s = r.S; e--; )
            (t = s[(a = c & (a + 1))]), (n = n * o + s[c & ((s[a] = s[(i = c & (i + t))]) + (s[i] = t))]);
      ...
      function p(e, t) {
        for (var n, r = e + '', a = 0; a < r.length; ) t[c & a] = c & ((n ^= 19 * t[c & a]) + r.charCodeAt(a++));
        return g(t);
      }
      function g(e) {
  ...
  var Ou = Au,
    ...
    Gu = Cu,
    Ku = Pu.exports;
  (Ku.alea = Ou), (Ku.xor128 = Lu), (Ku.xorwow = zu), (Ku.xorshift7 = Uu), (Ku.xor4096 = Wu), (Ku.tychei = Gu);
  var qu = Ku;
  function Vu() {
  ...
  function Hu(e, t, n) {
    ...
    if (((Rr(e) || Rr(t)) && (r = !1), Rr(e) && Rr(t) && (r = !0), r)) {
      ...
      if (a !== o) throw new Error('Arrays are of different type. Actual: '.concat(a, '. ') + 'Expected: '.concat(o));
    }
    if (Array.isArray(e) && Array.isArray(t)) {
      var i = ya(e),
        s = ya(t);
      if (!w(i, s)) throw new Error('Arrays have different shapes. ' + 'Actual: ['.concat(i, ']. Expected: [').concat(s, ']'));
    }
    var u = Rr(e) ? e : Br(e),
      c = Rr(t) ? t : Br(t);
    ...
    for (var l = 0; l < c.length; ++l) {
      ...
      if (!n(h, f))
        throw new Error(
          'Arrays differ: actual['.concat(l, '] = ').concat(h, ', expected[').concat(l, '] = ').concat(f, '.\n') +
            'Actual:   '.concat(u, '.\n') +
            'Expected: '.concat(c, '.'),
        );
    }
  ...
  var Zu = {
      ...
      expectArrayBuffersEqual: function (e, t) {
        ...
        if (n.length !== r.length)
          throw new Error('Expected ArrayBuffer to be of length ' + ''.concat(r.length, ', but it was ').concat(n.length));
        for (var a = 0; a < r.length; a++)
          if (n[a] !== r[a])
            throw new Error('Expected ArrayBuffer value at '.concat(a, ' to be ') + ''.concat(r[a], ' but got ').concat(n[a], ' instead'));
      },
      ...
      expectNumbersClose: function (e, t, n) {
        if ((null == n && (n = Vu()), !ju(e, t, n))) throw new Error('Numbers differ: actual === '.concat(e, ', expected === ').concat(t));
        'undefined' != typeof expect && expect().nothing();
      },
    ...
    Ju = (function () {
      function e(e, t, n, r, a) {
        ...
        var o = a || Math.random();
        this.random = qu.alea(o.toString());
      }
      return (
    ...
    Xu = (function () {
      function e(e, t, n, r) {
        ...
        if (
          ...
          throw new Error('The difference between '.concat(e, ' - ').concat(t, ' <= 1 and dtype is not float'));
        this.random = qu.alea(r);
      }
      return (
        (e.prototype.convertValue = function (e) {
  ...
  var Qu = Sa({
    randomGamma_: function (e, t, n, r, a) {
      ...
      for (var o = new Yu(t, n, r, a), i = yo(e, r), s = 0; s < i.values.length; s++) i.values[s] = o.nextValue();
      return i.toTensor();
    },
  });
  var $u = Sa({
    randomNormal_: function (e, t, n, r, a) {
      if ((void 0 === t && (t = 0), void 0 === n && (n = 1), G(e), null != r && 'bool' === r))
        throw new Error('Unsupported data type '.concat(r));
      for (var o = new Ju(t, n, r, !1, a), i = yo(e, r), s = 0; s < i.values.length; s++) i.values[s] = o.nextValue();
      return i.toTensor();
    },
  });
  var ec = Sa({
  ...
  var tc = Sa({
    randomUniform_: function (e, t, n, r, a) {
      void 0 === t && (t = 0), void 0 === n && (n = 1), void 0 === r && (r = 'float32'), G(e);
      for (var o = yo(e, r), i = new Xu(t, n, null, a), s = 0; s < o.values.length; s++) o.values[s] = i.nextValue();
      return o.toTensor();
    },
  });
  var nc = Sa({
    randomUniformInt_: function (e, t, n, r) {
      return tc(e, t, n, 'int32', r);
    },
  });
  function rc(e, t, n, r) {
  ...
  var vc = Sa({
    separableConv2d_: function (e, t, n, r, a, o, i) {
      ...
      var s = ka(e, 'x', 'separableConv2d'),
        ...
        l = s,
        h = !1;
      if ((3 === s.rank && ((h = !0), (l = ti(s, [1, s.shape[0], s.shape[1], s.shape[2]]))), 'NCHW' === i))
      ...
      var p = zi(l, u, r, a, i, o),
        v = _i(p, c, 1, 'valid', i);
      return h ? ti(v, [v.shape[1], v.shape[2], v.shape[3]]) : v;
    },
  });
  var mc = function (e, t) {
    return a(this, void 0, void 0, function () {
      ...
      return o(this, function (o) {
        switch (o.label) {
          ...
          case 2:
            ...
            for (c = new Gr([u], n.dtype), l = new Gr([u], 'int32'), h = 0, f = 0; h < a.length; h++)
  ...
  var Ac = Sa({
    softmax_: function (e, t) {
      ...
      if ((-1 === t && (t = n.rank - 1), t !== n.rank - 1))
        throw Error(
          'Softmax along a non-last dimension is not yet supported. ' + 'Logits was rank '.concat(n.rank, ' and dim was ').concat(t),
        );
      var r = { logits: n },
        a = { dim: t };
    ...
    irfft_: function (e) {
      ...
      if (n <= 2) {
        ...
        var o = [r, 2 * (n - 1)],
          i = ti(ac(e), [r, n]),
          s = ti(Es(e), [r, n]),
          u = uc(si(i, [0, 1], [r, n - 2]), 1),
          c = No(uc(si(s, [0, 1], [r, n - 2]), 1), ss(-1)),
          l = ai([i, u], 1),
          h = ai([s, c], 1);
        a = ti(Aa(l, h), [o[0], o[1]]);
        t = Ic(a);
      }
      if (((t = ac(t)), 3 === e.rank && 0 !== e.shape[0])) {
        var f = t,
          d = e.shape[0];
        (t = ti(t, [d, t.shape[0] / d, t.shape[1]])), f.dispose();
      }
      return t;
    },
  });
  ...
  var Tc = Sa({
    rfft_: function (e, t) {
      ...
      if (null != t && t < r) {
        ...
        (i[e.shape.length - 1] = t), (n = si(e, o, i)), (r = t);
      } else if (null != t && t > r) {
        var s = e.shape.map(function (e) {
          return e;
        });
        (s[e.shape.length - 1] = t - r), (n = ai([e, $s(s)], e.shape.length - 1)), (r = t);
      } else n = e;
      var u = Zi(n),
        c = ti(Aa(n, u), [a, r]),
        l = _c(c),
        ...
        f = ac(l),
        d = Es(l),
        p = Mc(f, [h, r - h], f.shape.length - 1),
        v = Mc(d, [h, r - h], d.shape.length - 1),
        m = n.shape.slice();
      return (m[n.shape.length - 1] = h), ti(Aa(p[0], v[0]), m);
    },
  });
  var Dc = Sa({
  ...
  var Rc = Sa({
    squeeze_: function (e, t) {
      ...
      return ti(n, S(n.shape, t).newShape);
    },
  });
  var Bc = Sa({
    stack_: function (e, t) {
  ...
  var Cc = Sa({
    stridedSlice_: function (e, t, n, r, a, o, i, s, u) {
      void 0 === a && (a = 0), void 0 === o && (o = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === u && (u = 0);
      var c = { x: ka(e, 'x', 'stridedSlice', 'string_or_numeric') },
        l = { begin: t, end: n, strides: r, beginMask: a, endMask: o, ellipsisMask: i, newAxisMask: s, shrinkAxisMask: u };
  ...
  function Uc(e, t, n) {
    ...
    if (e.length < r + (n.rank - a)) throw new Error(o + ' Output shape length < '.concat(r + (n.rank - a)));
    if (n.rank !== a + e.length - r) throw new Error(o + ' update.rank != '.concat(a + e.length - r));
    for (var i = 0; i < a; ++i)
      if (n.shape[i] !== t.shape[i])
        throw new Error(
          o + ' updates.shape['.concat(i, '] (').concat(n.shape[i], ') != indices.shape[').concat(i, '] (').concat(t.shape[i], ').'),
        );
  ...
  function Gc(e, t, n) {
    for (var r = t.shape.length, a = r > 1 ? t.shape[r - 1] : 1, o = n.length, i = 1, c = a; c < o; ++c) i *= n[c];
    var l = a < 1 ? 1 : a;
    return {
      sliceRank: a,
  ...
  var Kc = { __proto__: null, calculateShapes: Gc, validateInput: Wc, validateUpdateShape: Uc };
  var qc = Sa({
    tensorScatterUpdate_: function (e, t, n) {
      ...
      if ((Wc(o, a, r.shape), r.dtype !== o.dtype))
        throw new Error('tensor and updates must have the same dtype, instead they are '.concat(r.dtype, ' and ').concat(o.dtype, '.'));
  ...
  var Hc = Sa({
    truncatedNormal_: function (e, t, n, r, a) {
      ...
      for (var o = new Ju(t, n, r, !0, a), i = yo(e, r), s = 0; s < i.values.length; s++) i.values[s] = o.nextValue();
      return i.toTensor();
    },
  });
  var jc = Sa({
    ...
    return a(this, void 0, void 0, function () {
      ...
      return o(this, function (a) {
        switch (a.label) {
          ...
          case 1:
            return (n = a.sent()), (r = Yc(t.shape, n)), e !== t && t.dispose(), [2, r];
        }
      });
    });
  };
          ...
          case 0:
            for (
              r = ka(e, 'tensor', 'boolMask'),
                ...
                v(u.slice(i, i + s), a.shape, "mask's shape must match the first K dimensions of tensor's shape,"),
                c = 1,
                l = i;
              l < i + s;
              l++
              ...
              c *= u[l];
            return (h = u.slice(0, i).concat([c], u.slice(i + s))), (f = ti(r, h)), (d = ti(a, [-1])), [4, Xc(d)];
          case 1:
            return (
              (p = o.sent()),
              (m = Rc(p, [1])),
    ...
    transpose_: function (e, t, n) {
      ...
      return 'complex64' === r.dtype
        ? xo(function () {
            var e = ac(r),
              t = Es(r);
            return (e = da.runKernel(xn, { x: e }, o)), (t = da.runKernel(xn, { x: t }, o)), n && (t = Ps(t)), Aa(e, t);
          })
        : da.runKernel(xn, a, o);
    },
  });
  ...
  var al = Sa({
    dropout_: function (e, t, n, r) {
      ...
      var o = (function (e, t) {
        ...
        i = 1 - t,
        s = Io(bs(Ao(tc(o, 0, 1, 'float32', r), i)), i);
      return No(a, s);
    },
  });
  function ol(e) {
          ...
          switch (o.label) {
            case 0:
              return (
                ...
                g(r.rank > 1, function () {
                  return 'inTopK() expects the predictions to be of rank 2 or higher, ' + 'but got '.concat(r.rank);
                }),
                ...
                g(n > 0 && n <= i, function () {
                  return (
                    "'k' passed to inTopK() must be > 0 && <= the predictions last " + 'dimension ('.concat(i, '), but got ').concat(n)
                  );
                }),
                [4, r.data()]
              );
            ...
            case 2:
              for (c = o.sent(), l = s([u.length / i, i], 2), h = l[0], f = l[1], d = A('bool', h), p = 0; p < h; p++) {
                for (m = p * f, y = u.subarray(m, m + f), b = [], w = 0; w < y.length; w++) b.push({ value: y[w], index: w });
                for (
                  b.sort(function (e, t) {
              ...
              return e !== r && r.dispose(), t !== a && a.dispose(), [2, Ia(d, a.shape, 'bool')];
          }
        });
      })
    );
  ...
  var ul = Sa({
    conv2DBackpropFilter_: function (e, t, n, r, a, o, i) {
      void 0 === o && (o = 'NHWC');
      var s = e;
      3 === e.rank && (s = ti(e, [1, e.shape[0], e.shape[1], e.shape[2]]));
      var u = t;
      3 === u.rank && (u = ti(t, [1, t.shape[0], t.shape[1], t.shape[2]])),
        g(4 === s.rank, function () {
      ...
      g(c === n[2], function () {
        ...
        ei('conv2dDerFilter', a, i);
      var h = { x: s, dy: u },
        f = { strides: r, pad: a, dataFormat: o, dimRoundingMode: i, filterShape: n };
      return da.runKernel(Ee, h, f);
    },
  });
  function cl(e, t, n) {
    if (null == n || 'linear' === n) return e;
    if ('relu' === n) return No(e, Fc(t));
    throw new Error('Cannot compute gradient for fused activation '.concat(n, '.'));
  }
  function ll(e, t) {
    var n = t,
      r = Ki(e.shape, t.shape);
    return r.length > 0 && (n = ls(n, r)), ti(n, e.shape);
  }
  function hl(e, t, n, r) {
    if ('linear' === t) return e;
    if ('relu' === t) return ic(e);
    if ('elu' === t) return Qi(e);
    if ('relu6' === t) return sc(e);
    if ('prelu' === t) return yu(e, n);
    if ('leakyrelu' === t) return Is(e, r);
    if ('sigmoid' === t) return ii(e);
  ...
  var dl = Sa({
    fusedConv2d_: function (e) {
      var t,
        ...
        m = e.leakyreluAlpha;
      if (((p = p || 'linear'), !1 === fl(da.state.gradientDepth, p))) {
        g('NHWC' === u, function () {
          return (
        ...
        var y = _i(n, r, a, o, u, l, h);
        return null != f && (y = Ao(y, f)), hl(y, p, v, m);
      }
      var b = ka(n, 'x', 'conv2d', 'float32'),
        w = ka(r, 'filter', 'conv2d', 'float32'),
        k = b,
        x = !1;
      3 === b.rank && ((x = !0), (k = ti(b, [1, b.shape[0], b.shape[1], b.shape[2]]))),
        g(4 === k.rank, function () {
          return 'Error in fused conv2d: input must be rank 4, but got rank ' + ''.concat(k.rank, '.');
        }),
        g(4 === w.rank, function () {
          return 'Error in fused conv2d: filter must be rank 4, but got rank ' + ''.concat(w.rank, '.');
        }),
        ei('fused conv2d', o, h);
      var E = 'NHWC' === u ? k.shape[3] : k.shape[1];
      g(w.shape[2] === E, function () {
        return 'Error in conv2d: depth of input ('.concat(E, ') must match ') + 'input depth for filter '.concat(w.shape[2], '.');
      }),
        g(Xo(a, l), function () {
          return 'Error in conv2D: Either strides or dilations must be 1. ' + 'Got strides '.concat(a, " and dilations '").concat(l, "'");
        });
      var S,
        A,
        _ = Ko(k.shape, w.shape, a, l, o, h);
      if (
        (null != f &&
          ((t = s(ra((S = ka(f, 'bias', 'fused conv2d')), b), 1)),
          (S = t[0]),
          'NHWC' === u
            ? qi(_.outShape, S.shape)
            : (g(S.shape.length <= 1, function () {
              ...
              g(0 === S.shape.length || S.shape[0] === _.outChannels || 1 === S.shape[0], function () {
                return (
                  'Error in fused conv2d: bias shape ('.concat(S.shape, ') is not ') +
        ...
        if (
          ...
          try {
            ...
            var N =
              'Error in fused conv2d: PReLU activation weights ('.concat(I, ') ') +
      ...
      var M = function (e, t) {
          g('NHWC' === u, function () {
            return 'Error in gradient of fused conv2D: got dataFormat of '.concat(u, ' but only NHWC is currently supported.');
          });
          var n = s(t, 4),
            r = n[0],
            i = n[1],
          ...
          g(Yo(l), function () {
            return (
              ...
              "are not yet supported in gradients. Got dilations '".concat(l, "'")
            );
          });
          var d = [Ni(i.shape, f, r, a, o), ul(i, f, r.shape, a, o)];
          if (null != h) {
            var v = ll(h, f);
            d.push(v);
          }
        ...
        D = { strides: a, pad: o, dataFormat: u, dilations: l, dimRoundingMode: h, activation: p, leakyreluAlpha: m };
      if (null == f) {
        var R = Fs(function (e, t, n) {
          var r = da.runKernel(Dn, T, D);
          return n([t, e, r]), x && (r = ti(r, [r.shape[1], r.shape[2], r.shape[3]])), { value: r, gradFunc: M };
        });
        return R(k, w);
      }
      var B = Fs(function (e, t, n, r) {
        var a = da.runKernel(Dn, T, D);
        return r([t, e, a, n]), x && (a = ti(a, [a.shape[1], a.shape[2], a.shape[3]])), { value: a, gradFunc: M };
      });
      return B(k, w, S);
    },
  });
  var pl = Sa({
    depthwiseConv2dNativeBackpropFilter_: function (e, t, n, r, a, o, i) {
      ...
      3 === u.rank && (u = ti(t, [1, t.shape[0], t.shape[1], t.shape[2]]));
      var c = { x: s, dy: u },
        l = { strides: r, pad: a, dimRoundingMode: i, dilations: o, filterShape: n };
  ...
  var gl = Sa({
    depthwiseConv2dNativeBackpropInput_: function (e, t, n, r, a, o, i) {
      ...
      var s = t,
        u = !1;
      3 === t.rank && ((u = !0), (s = ti(t, [1, t.shape[0], t.shape[1], t.shape[2]])));
      var c = { dy: s, filter: n },
        l = { strides: r, pad: a, dimRoundingMode: i, dilations: o, inputShape: e },
        h = da.runKernel(Ce, c, l);
      return u ? ti(h, [h.shape[1], h.shape[2], h.shape[3]]) : h;
    },
  });
  var vl = Sa({
    fusedDepthwiseConv2d_: function (e) {
      var t,
        ...
        v = e.preluActivationWeights,
        m = e.leakyreluAlpha;
      if (!1 === fl(da.state.gradientDepth, p)) {
        var y = zi(n, r, a, o, u, l, h);
        return null != f && (y = Ao(y, f)), hl(y, p, v, m);
      }
      ...
      3 === b.rank && ((x = !0), (k = ti(b, [1, b.shape[0], b.shape[1], b.shape[2]]))),
        g(4 === k.rank, function () {
          return 'Error in fused depthwiseConv2d: input must be rank 4, but got ' + 'rank '.concat(k.rank, '.');
        }),
        g(4 === w.rank, function () {
          return 'Error in fused depthwiseConv2d: filter must be rank 4, ' + 'but got rank '.concat(w.rank, '.');
        }),
        g(k.shape[3] === w.shape[2], function () {
          return (
            'Error in fused depthwiseConv2d: number of input channels ' +
            '('.concat(k.shape[3], ') must match the inChannels dimension in ') +
        ...
        ei('fused depthwiseConv2d', o, h);
      var E,
        S,
        A = Ko(k.shape, w.shape, a, l, o, h, !0);
      null != f && ((t = s(ra((E = ka(f, 'bias', 'fused conv2d')), b), 1)), (E = t[0]), qi(A.outShape, E.shape)),
      ...
      var _ = function (e, t) {
          ...
          var n = s(t, 4),
            ...
            c = n[3],
            f = cl(e, u, p),
            d = gl(i.shape, f, r, a, o, l, h),
            v = pl(i, f, r.shape, a, o, l, h);
          return null != c ? [d, v, ll(E, f)] : [d, v];
        },
        I = { x: k, filter: w, bias: E, preluActivationWeights: S },
        N = { strides: a, pad: o, dataFormat: u, dilations: l, dimRoundingMode: h, activation: p, leakyreluAlpha: m };
      if (null == f) {
        var M = Fs(function (e, t, n) {
          var r = da.runKernel(Rn, I, N);
          return n([t, e, r]), x && (r = ti(r, [r.shape[1], r.shape[2], r.shape[3]])), { value: r, gradFunc: _ };
        });
        return M(k, w);
      }
      var T = Fs(function (e, t, n, r) {
        var a = da.runKernel(Rn, I, N);
        return r([t, e, a, n]), x && (a = ti(a, [a.shape[1], a.shape[2], a.shape[3]])), { value: a, gradFunc: _ };
      });
      return T(k, w, E);
    },
  });
  var ml = Sa({
      fusedMatMul_: function (e) {
        var t,
          ...
          d = e.leakyreluAlpha,
          p = void 0 === d ? 0.2 : d;
        if (!1 === fl(da.state.gradientDepth, h)) {
          var v = oi(n, r, o, u);
          return null != c && (v = Ao(v, c)), hl(v, h, f, p);
        }
        ...
        var N,
          M,
          T = qi(m.shape.slice(0, -2), b.shape.slice(0, -2)).concat([x, E]),
          D = ti(m, o ? [_, w, x] : [_, x, w]),
          R = ti(b, u ? [I, E, k] : [I, k, E]);
        null != c && ((N = s(ra((N = ka(c, 'bias', 'fused matMul')), m), 1)[0]), qi(T, N.shape)),
        ...
        var B = function (e, t) {
            var n,
              ...
              f = a[2],
              d = a[3],
              p = cl(ti(e, f.shape), f, h);
            return (
              o || u
                ? !o && u
                  ? ((n = oi(p, l, !1, !1)), (r = oi(p, i, !0, !1)))
                  : o && !u
                  ? ((n = oi(l, p, !1, !0)), (r = oi(i, p, !1, !1)))
                  : ((n = oi(l, p, !0, !0)), (r = oi(p, i, !0, !0)))
                : ((n = oi(p, l, !1, !0)), (r = oi(i, p, !0, !1))),
              null != c ? [n, r, ll(d, p)] : [n, r]
            );
          },
          F = { a: D, b: R, bias: N, preluActivationWeights: M },
          C = { transposeA: o, transposeB: u, activation: h, leakyreluAlpha: p };
        if (null == c) {
          var P = Fs(function (e, t, n) {
            var r = da.runKernel(Tn, F, C);
            return n([e, t, r]), { value: ti(r, T), gradFunc: B };
          });
          return P(D, R);
        }
        var O = Fs(function (e, t, n, r) {
          var a = da.runKernel(Tn, F, C);
          return r([e, t, a, n]), { value: ti(a, T), gradFunc: B };
        });
        return O(D, R, N);
      },
    }),
    yl = { __proto__: null, conv2d: dl, depthwiseConv2d: vl, matMul: ml };
  var bl = Sa({
    hammingWindow_: function (e) {
      return il(e, 0.54, 0.46);
    },
  });
  var wl = Sa({
  ...
  var kl = Sa({
    frame_: function (e, t, n, r, a) {
      ...
      for (var o = 0, i = []; o + t <= e.size; ) i.push(si(e, o, t)), (o += n);
      if (r)
        for (; o < e.size; ) {
          var s = o + t - e.size,
            u = ai([si(e, o, t - s), wi([s], a)]);
          i.push(u), (o += n);
        }
      return 0 === i.length ? Lc([], [0, t]) : ti(ai(i), [i.length, t]);
    },
  });
  var xl = Sa({
    stft_: function (e, t, n, r, a) {
      void 0 === a && (a = wl), null == r && (r = ol(t));
      var o = kl(e, t, n),
        i = No(o, a(t));
      return Tc(i, r);
    },
  ...
  var Al = Sa({
    grayscaleToRGB_: function (e) {
      ...
      return a.fill(1, 0, n), (a[n] = 3), ms(t, a);
    },
  });
  var _l = Sa({
    rgbToGrayscale_: function (e) {
      ...
      switch (t.rank) {
        ...
        case 4:
          ...
          break;
        case 5:
          a = Xi('ijklm,m->ijkl', i, s);
          break;
        case 6:
          a = Xi('ijklmn,n->ijklm', i, s);
          break;
        default:
          throw new Error('Not a valid tensor rank.');
      }
      return (a = gs(a, -1)), bo(a, o);
    },
  });
  var Il = Sa({
  ...
  function Nl(e, t, n, r, a, o) {
    null == r && (r = 0.5), null == a && (a = Number.NEGATIVE_INFINITY), null == o && (o = 0);
    var i = e.shape[0];
    return (
      (n = Math.min(n, i)),
      g(0 <= r && r <= 1, function () {
  ...
  var Ml = Sa({
    nonMaxSuppression_: function (e, t, n, r, a) {
      ...
      var o = ka(e, 'boxes', 'nonMaxSuppression', 'float32'),
        ...
        s = Nl(o, i, n, r, a),
        u = { maxOutputSize: (n = s.maxOutputSize), iouThreshold: (r = s.iouThreshold), scoreThreshold: (a = s.scoreThreshold) };
  ...
  function Rl(e, t, n, r, a) {
    return Cl(e, t, n, r, a, 0);
  }
  function Bl(e, t, n, r, a, o) {
    return Cl(e, t, n, r, a, 0, !1, o, !0);
  }
  function Fl(e, t, n, r, a, o) {
    return Cl(e, t, n, r, a, o, !0);
  }
  function Cl(e, t, n, r, a, o, i, c, l) {
    void 0 === i && (i = !1), void 0 === c && (c = !1), void 0 === l && (l = !1);
    for (var h = [], f = 0; f < t.length; f++) t[f] > a && h.push({ score: t[f], boxIndex: f, suppressBeginIndex: 0 });
    h.sort(Ll);
    for (var d = o > 0 ? -0.5 / o : 0, p = [], g = []; p.length < n && h.length > 0; ) {
      var v = h.pop(),
        m = v.score,
        y = v.boxIndex,
      ...
      for (var w = !1, k = p.length - 1; k >= b; --k) {
        ...
        if (((v.score = v.score * Ol(r, d, x)), v.score <= a)) break;
      }
      (v.suppressBeginIndex = p.length), w || (v.score === m ? (p.push(y), g.push(v.score)) : v.score > a && Tl(h, v, Ll));
    }
    var E = p.length,
      S = n - E;
    c && S > 0 && (p.push.apply(p, u([], s(new Array(S).fill(0)), !1)), g.push.apply(g, u([], s(new Array(S).fill(0)), !1)));
          ...
          switch (o.label) {
            ...
            case 1:
              return (
                ...
                (l = c[0]),
                (h = c[1]),
                (f = Rl(l, h, n, r, i).selectedIndices),
                a !== e && a.dispose(),
                s !== t && s.dispose(),
                [2, Oc(f, 'int32')]
              );
  ...
  var Ul = Sa({
    nonMaxSuppressionWithScore_: function (e, t, n, r, a, o) {
      void 0 === r && (r = 0.5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = 0);
          ...
          switch (o.label) {
            ...
            case 1:
              return (
                ...
                a !== e && a.dispose(),
                u !== t && u.dispose(),
                [2, { selectedIndices: Oc(p, 'int32'), selectedScores: Oc(g) }]
              );
          }
        });
      })
  ...
  var Gl = Sa({
    nonMaxSuppressionPadded_: function (e, t, n, r, a, o) {
      void 0 === r && (r = 0.5), void 0 === a && (a = Number.NEGATIVE_INFINITY), void 0 === o && (o = !1);
      var i = ka(e, 'boxes', 'nonMaxSuppression'),
        s = ka(t, 'scores', 'nonMaxSuppression'),
        u = Nl(i, s, n, r, a, null),
        c = { boxes: i, scores: s },
        l = { maxOutputSize: u.maxOutputSize, iouThreshold: u.iouThreshold, scoreThreshold: u.scoreThreshold, padToMaxOutputSize: o },
        h = da.runKernel(St, c, l);
      return { selectedIndices: h[0], validOutputs: h[1] };
    },
  });
  var Kl = function (e, t, n, r, i, u) {
    return (
      void 0 === r && (r = 0.5),
      void 0 === i && (i = Number.NEGATIVE_INFINITY),
      void 0 === u && (u = !1),
          ...
          switch (o.label) {
            ...
            case 1:
              return (
                ...
                a !== e && a.dispose(),
                c !== t && c.dispose(),
                [2, { selectedIndices: Oc(y, 'int32'), validOutputs: ss(b, 'int32') }]
              );
          }
        });
      })
  ...
  var ql = Sa({
    resizeBilinear_: function (e, t, n, r) {
      ...
      var o = a,
        i = !1;
      3 === a.rank && ((i = !0), (o = ti(a, [1, a.shape[0], a.shape[1], a.shape[2]]))), s(t, 0);
      var u = { images: o },
        c = { alignCorners: n, halfPixelCenters: r, size: t },
        l = da.runKernel(Wt, u, c);
      return i ? ti(l, [l.shape[1], l.shape[2], l.shape[3]]) : l;
    },
  });
  var Vl = Sa({
  ...
  var Hl = Sa({
    threshold_: function (e, t, n, r) {
      ...
      if (
        (g(3 === l.rank, function () {
          return 'Error in threshold: image must be rank 3,' + 'but got rank '.concat(l.rank, '.');
        }),
        g(3 === l.shape[2] || 1 === l.shape[2], function () {
          return 'Error in threshold: image color channel must be equal to 3 or 1' + 'but got '.concat(l.shape[2], '.');
        }),
        g('int32' === l.dtype || 'float32' === l.dtype, function () {
          return 'Error in dtype: image dtype must be int32 or float32,' + 'but got dtype '.concat(l.dtype, '.');
        }),
        ...
        (o = (a = s(Mc(l, [1, 1, 1], -1), 3))[0]), (i = a[1]), (u = a[2]);
        var d = No(o, 0.2989),
          p = No(i, 0.587),
          v = No(u, 0.114);
        c = Ao(Ao(d, p), v);
      ...
      'otsu' === t &&
        (f = (function (e, t) {
          for (var n, r, a, o, i, s, u = Oc([-1]), c = Oc([0]), l = Oc([0]), h = 0; h < e.size - 1; h++) {
            (n = si(e, 0, h + 1)), (r = si(e, h + 1)), (i = Io(ls(n), t)), (s = Io(ls(r), t));
            var f = ls(No(n, rc(0, n.size)));
            a = Io(f, ls(n));
            var d = wi(r.shape, n.size),
              p = Ao(rc(0, r.size), d),
              g = No(r, p);
            o = Io(ls(g), ls(r));
            var v = zs(a, o),
            ...
            l = No(No(y, v), m);
            var b = ks(l, c);
            (c = ji(b, l, c)), (u = ji(b, Oc([h]), u));
          }
          return u;
        })(gi(bo(dc(c), 'int32'), Ia([]), 256), h));
      var m = n ? Ms(c, f) : ks(c, f);
      return bo(No(m, 255), 'int32');
    },
  });
  var jl = Sa({
    transform_: function (e, t, n, r, a, o) {
      ...
      g(4 === i.rank, function () {
        ...
        g(2 === s.rank && (s.shape[0] === i.shape[0] || 1 === s.shape[0]) && 8 === s.shape[1], function () {
          return 'Error in transform: Input transform should be batch x 8 or 1 x 8';
        }),
        g(null == o || 2 === o.length, function () {
          return 'Error in transform: outputShape must be [height, width] or null, ' + 'but got '.concat(o, '.');
        });
    ...
    bandPart_: function (e, t, n) {
      ...
      'number' == typeof t
        ? (g(t % 1 == 0, function () {
          ...
          g(t <= c, function () {
            return 'bandPart(): numLower ('.concat(t, ')') + ' must not be greater than the number of rows ('.concat(c, ').');
          }),
          (a = ka(t < 0 ? c : t, 'numLower', 'bandPart')))
        : (g('int32' === t.dtype, function () {
            return "bandPart(): numLower's dtype must be an int32.";
          }),
          (a = ji(Ns(t, 0), c, tu(t, c)))),
        'number' == typeof n
          ? (g(n % 1 == 0, function () {
              return 'bandPart(): numUpper must be an integer, got '.concat(n, '.');
            }),
            g(n <= l, function () {
              return 'bandPart(): numUpper ('.concat(n, ')') + ' must not be greater than the number of columns ('.concat(l, ').');
            }),
            (o = ka(n < 0 ? l : n, 'numUpper', 'bandPart')))
          : (g('int32' === n.dtype, function () {
              return "bandPart(): numUpper's dtype must be an int32.";
            }),
            (o = ji(Ns(n, 0), l, tu(n, l))));
      var h = ti(rc(0, c, 1, 'int32'), [-1, 1]),
        f = rc(0, l, 1, 'int32'),
        d = zs(h, f),
        p = Gs(Ms(d, a), xs(d, Ps(o))),
        v = $s([c, l], r.dtype);
      return ti(
        Bc(
          Jc(ti(r, [-1, c, l])).map(function (e) {
            return ji(p, e, v);
          }),
        ),
        i,
  ...
  var Jl = Sa({
    gramSchmidt_: function (e) {
      ...
      if (Array.isArray(e)) {
        ...
        (t = !0),
          (e = Mc(e, e.shape[0], 0).map(function (e) {
            return Rc(e, [0]);
          }));
        ...
        s = function (e) {
          o.push(
            da.tidy(function () {
              ...
              if (e > 0)
                for (var n = 0; n < e; ++n) {
                  var r = No(ls(No(o[n], t)), o[n]);
                  t = zs(t, r);
                }
              return Io(t, fs(t, 'euclidean'));
            }),
          );
        };
        ...
        for (
          var n = e.shape[0],
            ...
            l = function (e) {
              ...
              (t = s(
                da.tidy(function () {
                  var t = si(o, [e, e], [n - e, 1]),
                    s = fs(t),
                    c = si(o, [e, e], [1, 1]),
                    l = ji(ks(c, 0), Lc([[-1]]), Lc([[1]])),
                    h = zs(c, No(l, s)),
                    f = Io(t, h);
                  u = 1 === f.shape[0] ? wo(i) : ai([i, si(f, [1, 0], [f.shape[0] - 1, f.shape[1]])], 0);
                  var d = Ps(Io(oi(l, h), s)),
                    p = si(o, [e, 0], [n - e, r]),
                    g = No(d, u),
                    v = $c(u);
                  if (0 === e) o = zs(p, oi(g, oi(v, p)));
                  else {
                    var m = zs(p, oi(g, oi(v, p)));
                    o = ai([si(o, [0, 0], [e, r]), m], 0);
                  }
                  var y = $c(g),
                    b = si(a, [0, e], [n, a.shape[1] - e]);
                  if (0 === e) a = zs(b, oi(oi(b, u), y));
                  else {
                    var w = zs(b, oi(oi(b, u), y));
                    a = ai([si(a, [0, 0], [n, e]), w], 1);
                  }
                  return [u, o, a];
                }),
                3,
          ...
          l(h);
        return !t && n > r && ((a = si(a, [0, 0], [n, r])), (o = si(o, [0, 0], [r, r]))), [a, o];
      })
    );
  }
  var Xl,
    Ql = Sa({
      qr_: function (e, t) {
        ...
        var n = e.shape.slice(0, e.shape.length - 2).reduce(function (e, t) {
          ...
          r = Jc(ti(e, [n, e.shape[e.shape.length - 2], e.shape[e.shape.length - 1]]), 0),
          a = [],
          o = [];
        return (
          r.forEach(function (e) {
          ...
          [ti(Bc(a, 0), e.shape), ti(Bc(o, 0), e.shape)]
        );
      },
    });
  (e.Reduction = void 0),
    ((Xl = e.Reduction || (e.Reduction = {}))[(Xl.NONE = 0)] = 'NONE'),
    (Xl[(Xl.MEAN = 1)] = 'MEAN'),
    (Xl[(Xl.SUM = 2)] = 'SUM'),
    (Xl[(Xl.SUM_BY_NONZERO_WEIGHTS = 3)] = 'SUM_BY_NONZERO_WEIGHTS');
  var $l = Sa({
    computeWeightedLoss_: function (t, n, r) {
      ...
      var i = null == o ? a : No(a, o);
      if (r === e.Reduction.NONE) return i;
      if (r === e.Reduction.SUM) return ls(i);
      if (r === e.Reduction.MEAN) {
        if (null == o) return Qs(i);
        var s = a.size / o.size,
          u = Io(ls(i), ls(o));
        return s > 1 ? Io(u, ss(s)) : u;
      }
      if (r === e.Reduction.SUM_BY_NONZERO_WEIGHTS) {
        if (null == o) return Io(ls(i), ss(a.size));
        var c = No(o, eu(a.shape)),
          l = bo(ls(su(c, ss(0))), 'float32');
        return Io(ls(i), l);
      }
  ...
  var eh = Sa({
    absoluteDifference_: function (t, n, r, a) {
      ...
      var o = ka(t, 'labels', 'absoluteDifference'),
        ...
        s = null;
      null != r && (s = ka(r, 'weights', 'absoluteDifference')), v(o.shape, i.shape, 'Error in absoluteDifference: ');
      var u = Mo(zs(o, i));
      return $l(u, s, a);
    },
  });
  var th = Sa({
    cosineDistance_: function (t, n, r, a, o) {
      ...
      var i = ka(t, 'labels', 'cosineDistance'),
        ...
        u = null;
      null != a && (u = ka(a, 'weights', 'cosineDistance')), v(i.shape, s.shape, 'Error in cosineDistance: ');
      var c = ss(1),
        l = zs(c, ls(No(i, s), r, !0));
      return $l(l, u, o);
    },
  });
  var nh = Sa({
    hingeLoss_: function (t, n, r, a) {
      ...
      var o = ka(t, 'labels', 'hingeLoss'),
        ...
        s = null;
      null != r && (s = ka(r, 'weights', 'hingeLoss')), v(o.shape, i.shape, 'Error in hingeLoss: ');
      var u = ss(1);
      o = zs(No(ss(2), o), u);
      var c = ic(zs(u, No(o, i)));
      return $l(c, s, a);
    },
  });
  var rh = Sa({
    huberLoss_: function (t, n, r, a, o) {
      ...
      var i = ka(t, 'labels', 'huberLoss'),
        ...
        u = null;
      null != r && (u = ka(r, 'weights', 'huberLoss')), v(i.shape, s.shape, 'Error in huberLoss: ');
      var c = ss(a),
        l = Mo(zs(s, i)),
        h = tu(l, c),
        f = zs(l, h),
        d = Ao(No(ss(0.5), cs(h)), No(c, f));
      return $l(d, u, o);
    },
  });
  var ah = Sa({
    logLoss_: function (t, n, r, a, o) {
      void 0 === a && (a = 1e-7), void 0 === o && (o = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
      var i = ka(t, 'labels', 'logLoss'),
        s = ka(n, 'predictions', 'logLoss'),
        u = null;
      null != r && (u = ka(r, 'weights', 'logLoss')), v(i.shape, s.shape, 'Error in logLoss: ');
      var c = ss(1),
        l = ss(a),
        h = Ps(No(i, Ds(Ao(s, l)))),
        f = No(zs(c, i), Ds(Ao(zs(c, s), l))),
        d = zs(h, f);
      return $l(d, u, o);
    },
  });
  var oh = Sa({
    meanSquaredError_: function (t, n, r, a) {
      ...
      var o = ka(t, 'labels', 'meanSquaredError'),
        ...
        s = null;
      null != r && (s = ka(r, 'weights', 'meanSquaredError')), v(o.shape, i.shape, 'Error in meanSquaredError: ');
      var u = Dc(o, i);
      return $l(u, s, a);
    },
  });
  var ih = Sa({
    sigmoidCrossEntropy_: function (t, n, r, a, o) {
      ...
      var i = ka(t, 'multiClassLabels', 'sigmoidCrossEntropy'),
        ...
        u = null;
      if ((null != r && (u = ka(r, 'weights', 'sigmoidCrossEntropy')), v(i.shape, s.shape, 'Error in sigmoidCrossEntropy: '), a > 0)) {
        var c = ss(a),
          l = ss(1),
          h = ss(0.5);
        i = Ao(No(i, zs(l, c)), No(h, c));
      }
      var f = (function (e, t) {
  ...
  var sh = Sa({
    softmaxCrossEntropy_: function (t, n, r, a, o) {
      ...
      var i = ka(t, 'onehotLabels', 'softmaxCrossEntropy'),
        ...
        c = null;
      if ((null != r && (c = ka(r, 'weights', 'softmaxCrossEntropy')), v(i.shape, u.shape, 'Error in softmaxCrossEntropy: '), a > 0)) {
        var l = ss(a),
          h = ss(1),
          f = ss(i.shape[1]);
        i = Ao(No(i, zs(h, l)), Io(l, f));
      }
          ...
          return {
            ...
            gradFunc: function (e, t) {
              var r = s(t, 2),
                ...
                o = r[1],
                i = rs(e.shape, [n]);
              return [No(ti(e, i), zs(bo(a, 'float32'), ps(o))), No(ti(e, i), zs(ps(o), bo(a, 'float32')))];
            },
          };
        });
        return r(e, t);
  ...
  var uh = Sa({
    sparseFillEmptyRows_: function (e, t, n, r) {
      ...
      if (1 !== o.rank) throw new Error('Values should be Tensor1D but received shape '.concat(o.shape));
  ...
  var ch = Sa({
    sparseReshape_: function (e, t, n) {
      ...
      if (1 !== o.rank) throw new Error('New shape should be Tensor1D but received shape '.concat(o.shape));
  ...
  var fh = Sa({
    stringNGrams_: function (e, t, n, r, a, o, i, s) {
      ...
      var l = { separator: n, nGramWidths: r, leftPad: a, rightPad: o, padWidth: i, preserveShortSequences: s },
        h = { data: u, dataSplits: c },
        f = da.runKernel(gn, h, l);
      return { nGrams: f[0], nGramsSplits: f[1] };
    },
  });
  var dh = { fft: _c, ifft: Ic, rfft: Tc, irfft: Nc },
    ph = { hammingWindow: bl, hannWindow: wl, frame: kl, stft: xl },
    gh = {
      flipLeftRight: Sl,
      grayscaleToRGB: Al,
      ...
      nonMaxSuppressionAsync: zl,
      nonMaxSuppressionWithScore: Ul,
      nonMaxSuppressionWithScoreAsync: Wl,
      nonMaxSuppressionPadded: Gl,
      nonMaxSuppressionPaddedAsync: Kl,
      threshold: Hl,
      transform: jl,
    },
    vh = { bandPart: Zl, gramSchmidt: Jl, qr: Ql },
    mh = {
      absoluteDifference: eh,
      ...
      logLoss: ah,
      meanSquaredError: oh,
      sigmoidCrossEntropy: ih,
      softmaxCrossEntropy: sh,
    },
    yh = { sparseFillEmptyRows: uh, sparseReshape: ch, sparseSegmentMean: lh, sparseSegmentSum: hh },
    bh = {
      stringNGrams: fh,
      stringSplit: Sa({
  ...
  function Sh(e, t, n) {
    ...
    var r = t + '>' + n;
    return Eh.register(e), wh.set(r, e), kh.set(e, r), e;
  }
  var Ah = {
      __proto__: null,
      Serializable: xh,
      ...
      getRegisteredName: function (e) {
        return kh.has(e) ? kh.get(e) : e.className;
      },
      registerClass: Sh,
    },
    _h = (function (e) {
      ...
      return (
        ...
        (t.prototype.minimize = function (e, t, n) {
          ...
          return Eo(o), t ? a : (a.dispose(), null);
        }),
        ...
        (t.prototype.dispose = function () {
          null != this.iterations_ && Eo(this.iterations_);
        }),
        (t.prototype.saveIterations = function () {
          return a(this, void 0, void 0, function () {
            return o(this, function (e) {
              return null == this.iterations_ && (this.iterations_ = 0), [2, { name: 'iter', tensor: ss(this.iterations_, 'int32') }];
            });
          });
        }),
  ...
  Object.defineProperty(_h, Symbol.hasInstance, {
    value: function (e) {
  ...
  var Ih = (function (e) {
          ...
          (Array.isArray(e)
            ...
            null == t.accumulatedGrads[r] &&
              (t.accumulatedGrads[r] = {
                ...
                variable: xo(function () {
                  return Zi(a).variable(false);
                }),
              }),
            ...
            if (null != o) {
              ...
              xo(function () {
                var e = Ao(No(i, t.rho), No(cs(o), 1 - t.rho)),
                  n = No(Io(us(Ao(s, t.epsilon)), us(Ao(i, t.epsilon))), o),
                  r = Ao(No(s, t.rho), No(cs(n), 1 - t.rho));
                i.assign(e), s.assign(r);
                var u = Ao(No(n, -t.learningRate), a);
                a.assign(u);
              });
            }
          }),
        ...
        (t.prototype.getWeights = function () {
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (t) {
              switch (t.label) {
                case 0:
                  return (e = u(u([], s(this.accumulatedGrads), !1), s(this.accumulatedUpdates), !1)), [4, this.saveIterations()];
                case 1:
                  return [
                    2,
                    [t.sent()].concat(
                ...
                case 1:
                  return (
                    ...
                    (this.accumulatedGrads = e.slice(0, t).map(function (e) {
                      return { originalName: e.name, variable: e.tensor.variable(false) };
                    })),
          ...
          (Array.isArray(e)
            ...
            if (null == t.accumulatedGrads[r]) {
              t.accumulatedGrads[r] = {
                ...
                variable: xo(function () {
                  return wi(a.shape, t.initialAccumulatorValue).variable(false);
                }),
              };
            }
            var o = Array.isArray(e) ? e[r].tensor : e[n];
            if (null != o) {
              ...
              xo(function () {
                var e = Ao(i, cs(o));
                i.assign(e);
                var n = Ao(No(Io(o, us(Ao(e, da.backend.epsilon()))), -t.learningRate), a);
                a.assign(n);
              });
            }
          }),
    ...
    Mh = (function (e) {
      function t(t, n, r, a) {
        ...
        return (
          ...
          xo(function () {
            (o.accBeta1 = ss(n).variable()), (o.accBeta2 = ss(r).variable());
          }),
            ...
            n.forEach(function (n, o) {
              ...
              if (null != s) {
                var u = t.accumulatedFirstMoment[o].variable,
                  ...
                  l = Ao(No(u, t.beta1), No(s, 1 - t.beta1)),
                  h = Ao(No(c, t.beta2), No(cs(s), 1 - t.beta2)),
                  f = Io(l, r),
                  d = Io(h, a);
                u.assign(l), c.assign(h);
                var p = Ao(No(Io(f, Ao(us(d), t.epsilon)), -t.learningRate), i);
                i.assign(p);
              }
            }),
              t.accBeta1.assign(No(t.accBeta1, t.beta1)),
              t.accBeta2.assign(No(t.accBeta2, t.beta2));
          }),
            this.incrementIterations();
        }),
        (t.prototype.dispose = function () {
          ...
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (t) {
              switch (t.label) {
                case 0:
                  return (
                    (e = u(u([], s(this.accumulatedFirstMoment), !1), s(this.accumulatedSecondMoment), !1)), [4, this.saveIterations()]
                  );
                case 1:
                  return [
                    2,
              ...
              switch (r.label) {
                ...
                case 1:
                  return (
                    (e = r.sent()),
                    xo(function () {
                      n.accBeta1.assign(is(n.beta1, n.iterations_ + 1)), n.accBeta2.assign(is(n.beta2, n.iterations_ + 1));
                    }),
                    (t = e.length / 2),
                    !1,
    ...
    Th = (function (e) {
      function t(t, n, r, a, o) {
        ...
        return (
          ...
          xo(function () {
            (i.iteration = ss(0).variable()), (i.accBeta1 = ss(n).variable());
          }),
      ...
      return (
        ...
        (t.prototype.applyGradients = function (e) {
          ...
          xo(function () {
            var r = zs(1, t.accBeta1),
              a = Io(-t.learningRate, Ao(No(t.iteration, t.decay), 1));
            n.forEach(function (n, o) {
              var i = da.registeredVariables[n];
              null == t.accumulatedFirstMoment[o] &&
                (t.accumulatedFirstMoment[o] = { originalName: ''.concat(n, '/m'), variable: Zi(i).variable(false) }),
                null == t.accumulatedWeightedInfNorm[o] &&
                  (t.accumulatedWeightedInfNorm[o] = { originalName: ''.concat(n, '/v'), variable: Zi(i).variable(false) });
              var s = Array.isArray(e) ? e[o].tensor : e[n];
              if (null != s) {
                var u = t.accumulatedFirstMoment[o].variable,
                ...
                var p = Ao(No(Io(a, r), Io(l, Ao(d, t.epsilon))), i);
                i.assign(p);
              }
            }),
              t.iteration.assign(Ao(t.iteration, 1)),
              t.accBeta1.assign(No(t.accBeta1, t.beta1));
          }),
            this.incrementIterations();
        }),
    ...
    Dh = (function (e) {
      ...
      return (
        ...
        (t.prototype.setLearningRate = function (e) {
          (this.learningRate = e), null != this.c && this.c.dispose(), (this.c = So(ss(-e)));
        }),
        (t.prototype.dispose = function () {
          this.c.dispose();
        }),
    ...
    Rh = (function (e) {
      function t(t, n, r) {
        ...
        return (a.learningRate = t), (a.momentum = n), (a.useNesterov = r), (a.accumulations = []), (a.m = ss(a.momentum)), a;
      }
      return (
        r(t, e),
        Object.defineProperty(t, 'className', {
          ...
          (Array.isArray(e)
            ...
            null != i &&
              xo(function () {
                var e,
                  n = Ao(No(t.m, o), i);
                (e = t.useNesterov ? Ao(No(t.c, Ao(i, No(n, t.m))), a) : Ao(No(t.c, n), a)), o.assign(n), a.assign(e);
              });
          }),
            this.incrementIterations();
        }),
    ...
    Bh = (function (e) {
      function t(t, n, r, a, o) {
        void 0 === n && (n = 0.9), void 0 === r && (r = 0), void 0 === a && (a = null), void 0 === o && (o = !1);
        var i = e.call(this) || this;
        if (
          ((i.learningRate = t),
          (i.decay = n),
        ...
        (t.prototype.applyGradients = function (e) {
          ...
          (Array.isArray(e)
            ...
            if (null != i) {
              ...
              xo(function () {
                var e = Ao(No(s, t.decay), No(cs(i), 1 - t.decay));
                if (t.centered) {
                  var n = t.accumulatedMeanGrads[r].variable,
                    o = Ao(No(n, t.decay), No(i, 1 - t.decay)),
                    c = Io(No(i, t.learningRate), us(zs(e, Ao(cs(o), t.epsilon)))),
                    l = Ao(No(u, t.momentum), c);
                  s.assign(e), n.assign(o), u.assign(l);
                  var h = zs(a, l);
                  a.assign(h);
                } else {
                  var f = Ao(No(s, t.decay), No(cs(i), 1 - t.decay));
                  l = Ao(No(u, t.momentum), Io(No(i, t.learningRate), us(Ao(f, t.epsilon))));
          ...
          return a(this, void 0, void 0, function () {
            ...
            return o(this, function (t) {
              switch (t.label) {
                case 0:
                  return (
                    (e = u(u([], s(this.accumulatedMeanSquares), !1), s(this.accumulatedMoments), !1)),
                    this.centered && e.push.apply(e, u([], s(this.accumulatedMeanGrads), !1)),
                ...
                case 1:
                  return (
                    ...
                    (this.accumulatedMeanSquares = e.slice(0, t).map(function (e) {
                      return { originalName: e.name, variable: e.tensor.variable(n) };
                    })),
                    (this.accumulatedMoments = e.slice(t, 2 * t).map(function (e) {
                      return { originalName: e.name, variable: e.tensor.variable(n) };
                    })),
                    this.centered &&
                      (this.accumulatedMeanGrads = e.slice(2 * t, 3 * t).map(function (e) {
                        return { originalName: e.name, variable: e.tensor.variable(n) };
                      })),
                    [2]
                  );
        ...
        return a(this, void 0, void 0, function () {
          ...
          return o(this, function (o) {
            switch (o.label) {
              ...
              case 1:
                return (
                  (r = [{ paths: ['./' + this.weightDataFileName], weights: e.weightSpecs }]),
                  (a = Ca(e, r)),
                  (i = window.URL.createObjectURL(new Blob([JSON.stringify(a)], { type: 'application/json' }))),
                  ((s = null == this.modelJsonAnchor ? document.createElement('a') : this.modelJsonAnchor).download =
              ...
              case 2:
                return (
                  ...
                  null == e.weightData
                    ? [3, 4]
                    : (((u = null == this.weightDataAnchor ? document.createElement('a') : this.weightDataAnchor).download =
              ...
              case 3:
                o.sent(), (o.label = 4);
              case 4:
                return [2, { modelArtifactsInfo: La(e) }];
            }
          });
        });
      }),
  ...
  Ph.URL_SCHEME = 'downloads://';
  var Oh = (function () {
    function e(e) {
      if (null == e || e.length < 1)
        throw new Error('When calling browserFiles, at least 1 file is required, ' + 'but received '.concat(e));
                  ...
                  if (null != o)
                    if (null != a.weightsManifest)
                      if (0 !== e.weightsFiles.length) {
                        var i = Oa(a, function (t) {
                          return e.loadWeights(t);
                        });
                        t(i);
                      } else t({ modelTopology: o });
                    else n(new Error('weightManifest field is missing from file '.concat(e.jsonFile.name)));
                  else n(new Error('modelTopology field is missing from file '.concat(e.jsonFile.name)));
                }),
                  (r.onerror = function (t) {
                    return n(
                      'Failed to read model topology and weights manifest JSON ' +
                        "from file '".concat(e.jsonFile.name, "'. BrowserFiles supports loading ") +
        ...
        try {
          for (var u = i(e), c = u.next(); !c.done; c = u.next()) {
            c.value.paths.forEach(function (e) {
              var t = Fa(e);
              if (-1 !== a.indexOf(t)) throw new Error('Duplicate file basename found in weights manifest: ' + "'".concat(t, "'"));
              if ((a.push(t), -1 === o.indexOf(t))) throw new Error("Weight file with basename '".concat(t, "' is not provided."));
        ...
        if (a.length !== this.weightsFiles.length)
          throw new Error(
            'Mismatch in the number of files in weights manifest ' +
              '('.concat(a.length, ') and the number of weight files provided ') +
    ...
    !(function (e) {
      ...
      (function (e, t) {
        g(e >= 0 && e <= 1, function () {
          ...
          g(t >= e, function () {
            return (
              'startFraction must be no more than endFraction, but ' + 'got startFraction '.concat(e, ' and endFraction ') + ''.concat(t)
            );
          });
      ...
      return o(this, function (o) {
        switch (o.label) {
          case 0:
            return (
              null == t && (t = {}),
              (n = null == t.fetchFunc ? J().platform.fetch : t.fetchFunc),
              (r = e.map(function (e) {
          ...
          case 1:
            return (s = o.sent()), [3, 4];
          case 2:
            return [4, Lh(r, t.onProgress, a, i)];
          case 3:
            (s = o.sent()), (o.label = 4);
          case 4:
            return (
          ...
          case 5:
            return (h = o.sent()), [3, 8];
          case 6:
            return [4, Lh(u, t.onProgress, c, l)];
          case 7:
            (h = o.sent()), (o.label = 8);
          case 8:
            return [2, h];
                ...
                if (
                  ...
                  n.forEach(function (e, n) {
                    ...
                    e.weights.forEach(function (e) {
                      var o = 'quantization' in e ? e.quantization.dtype : e.dtype,
                        c = Na[o] * y(e.shape),
                        l = function () {
                          (t[n] = !0), null == a[n] && (a[n] = []), a[n].push({ manifestEntry: e, groupOffset: r, sizeBytes: c });
                        };
                      null != i
                ...
                return (
                  ...
                  l.forEach(function (e) {
                    ...
                    a[e].forEach(function (e) {
                      var t = Ta(r.slice(e.groupOffset, e.groupOffset + e.sizeBytes), [e.manifestEntry]);
  ...
  Wa.registerSaveRouter(function (e) {
    return J().getBool('IS_BROWSER') && !Array.isArray(e) && e.startsWith(Ph.URL_SCHEME)
      ? (function (e) {
          void 0 === e && (e = 'model');
          return new Ph(e);
        })(e.slice(Ph.URL_SCHEME.length))
      : null;
  });
  var Wh = (function () {
    function e(e, t) {
    ...
    return (
          ...
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                ...
                return (
                  ((t = Object.assign({ method: this.DEFAULT_METHOD }, this.requestInit)).body = new FormData()),
                  (n = [{ paths: ['./model.weights.bin'], weights: e.weightSpecs }]),
                  (r = Ca(e, n)),
                  t.body.append('model.json', new Blob([JSON.stringify(r)], { type: 'application/json' }), 'model.json'),
                  null != e.weightData &&
                    ((a = Ma.join(e.weightData)),
                    t.body.append('model.weights.bin', new Blob([a], { type: 'application/octet-stream' }), 'model.weights.bin')),
                  [4, this.fetch(this.path, t)]
                );
              case 1:
                if ((i = o.sent()).ok) return [2, { modelArtifactsInfo: La(e), responses: [i] }];
                throw new Error('BrowserHTTPRequest.save() failed due to HTTP response status ' + ''.concat(i.status, '.'));
            }
          });
        });
      }),
          ...
          return o(this, function (o) {
            switch (o.label) {
              ...
              case 1:
                if (!(e = o.sent()).ok)
                  throw new Error(
                    'Request to '.concat(this.path, ' failed with status code ') +
                      ''.concat(e.status, '. Please verify this URL points to ') +
              ...
              case 4:
                throw (
                  (o.sent(),
                  (n = 'Failed to parse model JSON of response from '.concat(this.path, '.')),
              ...
              case 5:
                if (((r = t.modelTopology), (a = t.weightsManifest), null == r && null == a))
                  throw new Error(
                    'The JSON from HTTP path '.concat(this.path, ' contains neither model ') + 'topology or manifest for weights.',
                  );
                return [
                  2,
                  Oa(t, function (e) {
      ...
      (e.prototype.loadWeights = function (e) {
        return a(this, void 0, void 0, function () {
          var t, n, r, a, c, l, h, f, d, p, g, v, m, y, b, w, k, x, E, S, A, _, I;
          return o(this, function (o) {
            switch (o.label) {
              case 0:
                (t = Array.isArray(this.path) ? this.path[1] : this.path),
                  ...
                  (f = []);
                try {
                  for (d = i(e), p = d.next(); !p.done; p = d.next()) {
                    g = p.value;
                    try {
                      for (_ = void 0, v = i(g.paths), m = v.next(); !m.done; m = v.next())
                        (y = m.value), null != this.weightUrlConverter ? f.push(this.weightUrlConverter(y)) : h.push(c + y + a);
                    } catch (e) {
                      _ = { error: e };
                    } finally {
                      try {
                ...
                return this.weightUrlConverter ? ((w = (b = h.push).apply), (k = [h]), (x = [[]]), [4, Promise.all(f)]) : [3, 2];
              case 1:
                w.apply(b, k.concat([u.apply(void 0, x.concat([s.apply(void 0, [o.sent()]), !1]))])), (o.label = 2);
              case 2:
                return [4, zh(h, { requestInit: this.requestInit, fetchFunc: this.fetch, onProgress: this.onProgress })];
              case 3:
                return (E = o.sent()), [2, [l, E]];
            }
          });
        });
      }),
  ...
  function Gh(e) {
    return null != e.match(Wh.URL_SCHEME_REGEX);
  }
  Wh.URL_SCHEME_REGEX = /^https?:\/\//;
  var Kh = function (e, t) {
  ...
  Wa.registerSaveRouter(Kh), Wa.registerLoadRouter(Kh);
  var Vh = (function () {
      function e(e) {
    ...
    if (1 === arguments.length) {
      ...
      return a
        ...
        : (console.warn(
          ...
          new Vh({ modelTopology: e }));
    }
    return (
      console.warn(
        'Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release.',
      ),
      new Vh({ modelTopology: e, weightSpecs: t, weightData: n, trainingConfig: r })
    );
  }
  var Jh = {
    __proto__: null,
      ...
      return a(this, void 0, void 0, function () {
        ...
        return o(this, function (l) {
          switch (l.label) {
                ...
                n = [],
                  ...
                  s = function (s) {
                    ...
                    if (
                      ...
                      throw new Error("Unsupported dtype in weight '".concat(u, "': ").concat(l.dtype));
                            ...
                            switch (o.label) {
                              ...
                              case 1:
                                for (
                                  ...
                                  (s = t[i]),
                                    (u = new Uint8Array(new Uint32Array([s.length]).buffer)),
                                    r.set(u, a),
                                    (a += 4),
                                    r.set(s, a),
                                    (a += s.length);
            ...
            case 1:
              return [2, { data: Da(l.sent()), specs: n }];
          }
        });
      });
    },
    fromMemory: function (e, t, n, r) {
      var a = arguments;
      return new jh(Zh.apply(void 0, u([], s(a), !1)));
    },
    fromMemorySync: Zh,
    getLoadHandlers: function (e, t) {
      return Wa.getLoadHandlers(e, t);
    },
    getModelArtifactsForJSON: Oa,
    getModelArtifactsForJSONSync: Pa,
    getModelArtifactsInfoForJSON: La,
    getSaveHandlers: function (e) {
      return Wa.getSaveHandlers(e);
    },
    getWeightSpecs: za,
    http: qh,
    isHTTPScheme: Gh,
    listModels: function () {
      return a(this, void 0, void 0, function () {
        ...
        return o(this, function (o) {
          switch (o.label) {
            case 0:
              (e = lo.getSchemes()), (t = {}), (o.label = 1);
            case 1:
              o.trys.push([1, 6, 7, 8]), (n = i(e)), (r = n.next()), (o.label = 2);
            case 2:
              return r.done ? [3, 5] : ((a = r.value), [4, lo.getManager(a).listModels()]);
            case 3:
              for (u in (s = o.sent())) t[a + co + u] = s[u];
              o.label = 4;
            case 4:
              return (r = n.next()), [3, 2];
            case 5:
    ...
    moveModel: function (e, t) {
      return a(this, void 0, void 0, function () {
        return o(this, function (n) {
          return !0, [2, fo(e, t, true)];
        });
      });
    },
    registerLoadRouter: function (e) {
      return Wa.registerLoadRouter(e);
    },
    registerSaveRouter: function (e) {
      return Wa.registerSaveRouter(e);
    },
    removeModel: function (e) {
      return a(this, void 0, void 0, function () {
        var t;
        return o(this, function (n) {
          return (t = ho(e)), [2, lo.getManager(t.scheme).removeModel(t.path)];
        });
      });
    },
    weightsLoaderFactory: Uh,
    ...
    if (i) h = e.getContext('2d').getImageData(0, 0, p, g).data;
      ...
      if (null == Yh)
        if ('undefined' == typeof document) {
          ...
          Yh = new OffscreenCanvas(1, 1).getContext('2d');
        } else Yh = document.createElement('canvas').getContext('2d', { willReadFrequently: !0 });
      (Yh.canvas.width = p), (Yh.canvas.height = g), Yh.drawImage(e, 0, 0, p, g), (h = Yh.getImageData(0, 0, p, g).data);
    }
    if (4 === t) f = new Int32Array(h);
    else {
      var v = p * g;
      f = new Int32Array(v * t);
      for (var m = 0; m < v; m++) for (var y = 0; y < t; ++y) f[m * t + y] = h[4 * m + y];
    }
    return zc(f, [g, p, t], 'int32');
  }
  function ef(e) {
    return (
      'undefined' != typeof window &&
  ...
  function tf(e) {
    ...
    if ('float32' !== e.dtype && 'int32' !== e.dtype)
      throw new Error('Unsupported type for toPixels: '.concat(e.dtype, '.') + ' Please use float32 or int32 tensors.');
  }
  var nf = {
    __proto__: null,
    draw: function (e, t, n) {
      ...
      return (
        ...
        a(this, void 0, void 0, function () {
          ...
          return o(this, function (a) {
            switch (a.label) {
              case 0:
                if (((n = null), !J().getBool('WRAP_TO_IMAGEBITMAP') || !ef(e))) return [3, 5];
                (r = void 0), (a.label = 1);
              case 1:
                return a.trys.push([1, 3, , 4]), [4, createImageBitmap(e, { premultiplyAlpha: 'none' })];
              case 2:
                return (r = a.sent()), [3, 4];
              case 3:
                return a.sent(), (r = null), [3, 4];
              case 4:
                return (n = null != r && r.width === e.width && r.height === e.height ? r : e), [3, 6];
              case 5:
                (n = e), (a.label = 6);
              case 6:
                return [2, $h(n, t)];
        ...
        return o(this, function (o) {
          switch (o.label) {
            case 0:
              return (
                (n = ka(e, 'img', 'toPixels')),
                e instanceof Vr || ((n = bo((r = n), 'int32')), r.dispose()),
                tf(n),
            ...
            case 1:
              for (l = o.sent(), h = 'float32' === n.dtype ? 255 : 1, f = new Uint8ClampedArray(u * i * 4), d = 0; d < i * u; ++d) {
                for (p = [0, 0, 0, 255], g = 0; g < c; g++) {
                  if (((v = l[d * c + g]), 'float32' === n.dtype)) {
                    if (v < 0 || v > 1)
                      throw new Error(
                        'Tensor values for a float32 Tensor must be in the ' + 'range [0 - 1] but encountered '.concat(v, '.'),
                      );
                  } else if ('int32' === n.dtype && (v < 0 || v > 255))
                    throw new Error('Tensor values for a int32 Tensor must be in the ' + 'range [0 - 255] but encountered '.concat(v, '.'));
                  1 === c ? ((p[0] = v * h), (p[1] = v * h), (p[2] = v * h)) : (p[g] = v * h);
                }
  ...
  function rf(e, t) {
    ...
    if (t.shape[r - 1] > n)
      throw new Error('index innermost dimension length must be <= tensor rank; saw: ' + ''.concat(t.shape[r - 1], ' vs. ').concat(n));
    if (0 === y(e.shape)) throw new Error('Requested more than 0 entries, but input is empty.' + ' Input shape: '.concat(e.shape, '.'));
  ...
  var af = { __proto__: null, prepareAndValidate: rf };
  function of(e, t, n, r) {
  ...
  function cf(e, t, n, r, a) {
    for (var o = u([], s(a), !1), i = uf(n, t), c = 0; c < o.length; c++)
    ...
    vf = {
        ...
        for (
          var a = function (a) {
              g(t[a] + n[a] <= e.shape[a], function () {
                return (
                  'Error in slice'.concat(r, 'D: begin[').concat(a, '] + size[').concat(a, '] ') +
                  '('
      ...
      getNormalizedAxes: function (e, t, n, r, a, o, i, s, u) {
        ...
        if (t.length && n > 0) {
          var d = t[0],
            p = n + 1;
          (l = cf(i, d, p, r, e)), (h = lf(s, d, p, a, e)), (f = of(o, d, p, e));
        } else for (var g = 0; g < c; g++) (l[g] = ff(i, r, o, e, g, u)), (h[g] = df(s, a, o, e, g, u)), (f[g] = hf(o, g, u));
      ...
      isSliceContinous: function (e, t, n) {
        ...
        for (a = r + 1; a < n.length; a++) if (t[a] > 0 || n[a] !== e[a]) return !1;
        return !0;
      },
        ...
        return (
          ...
          (a = (a =
            ...
            return t >= 0
              ...
              : (g(-1 === t, function () {
                  return (
                    'Negative size values should be exactly -1 but got ' + ''.concat(t, ' for the slice() size at index ').concat(n, '.')
                  );
                }),
                e.shape[n] - r[n]);
          })),
      ...
      sliceInfo: function (e, t, n, r, a, o, i, s, u) {
        var c;
        if ((null == r ? (c = new Array(t.length)).fill(1) : (c = r), null != i && 0 != (i & (i - 1))))
        ...
        for (
          ...
          l && 0 != ((1 << f) & s) && h.numAddAxisAfterEllipsis++, (1 << f) & i && (l = !0);
        l || ((h.ellipsisMask |= 1 << h.dims), h.dims++);
        var d = { dims: e.length, beginMask: 0, endMask: 0, beginValid: !1, endValid: !1 };
        !(function (e, t) {
              ...
              if (n === t.begin.length)
                throw Error(
                  'Index out of range using input dim '.concat(n, '; input ') +
                    'has only '.concat(t.dims, ' dims, ').concat(t.begin.length, '.'),
                );
        ...
        for (f = 0; f < e.length; ++f) {
          ...
          if (-1 !== w) {
            ...
            if (b && d.strides[f] <= 0) throw Error('only stride 1 allowed on non-range indexing.');
            v = v && 1 === d.strides[f];
            ...
            if (d.beginValid && d.endValid) {
              if (b) {
                ...
                if (((d.begin[f] = S), (d.end[f] = d.begin[f] + 1), S < 0 || S >= w))
                  throw Error('slice index '.concat(d.begin[f], ' of dimension ').concat(f, ' out of bounds.'));
              } else (d.begin[f] = pf(d.begin[f], 0, d.strides[f], w, k, x)), (d.end[f] = pf(d.end[f], 1, d.strides[f], w, k, x));
              var A = 1 === d.strides[f] && 0 === d.begin[f] && d.end[f] === w;
              (p = p && A), (g = g && ((0 === f && 1 === d.strides[f]) || A));
            } else (p = p && 1 === d.strides[f] && E), (g = g && ((0 === f && 1 === d.strides[f]) || E));
            var _ = void 0,
              I = !1;
            if (
              ...
              var N = void 0;
              (N = 0 === _ || _ < 0 != d.strides[f] < 0 ? 0 : Math.trunc(_ / d.strides[f]) + (_ % d.strides[f] != 0 ? 1 : 0)), m.push(N);
            } else m.push(-1);
          } else m.push(b ? 1 : -1);
        }
      ...
      startForAxis: ff,
      startIndicesWithElidedDims: cf,
      stopForAxis: df,
      stopIndicesWithElidedDims: lf,
      stridesForAxis: hf,
      stridesWithElidedDims: of,
    },
    mf = (function () {
      function e() {}
      return (
        ...
        (e.momentum = function (e, t, n) {
          return void 0 === n && (n = !1), new Rh(e, t, n);
        }),
        (e.rmsprop = function (e, t, n, r, a) {
          return (
            void 0 === t && (t = 0.9), void 0 === n && (n = 0), void 0 === r && (r = null), void 0 === a && (a = !1), new Bh(e, t, n, r, a)
          );
        }),
        ...
        (e.adadelta = function (e, t, n) {
          return void 0 === e && (e = 0.001), void 0 === t && (t = 0.95), void 0 === n && (n = null), new Ih(e, t, n);
        }),
        ...
        (e.adagrad = function (e, t) {
          return void 0 === t && (t = 0.1), new Nh(e, t);
        }),
        e
      );
    })(),
  ...
  var Ef = {
      ...
      assertParamsConsistent: function (e, t) {
        ...
        e.forEach(function (e, t) {
          g(e.length === n, function () {
            return (
              'Error in concat'.concat(n, 'D: rank of tensors[').concat(t, '] must be the same ') +
        ...
        e.forEach(function (e, a) {
          for (var o = 0; o < n; o++)
            g(o === t || e[o] === r[o], function () {
              return (
                'Error in concat'.concat(n, 'D: Shape of tensors[').concat(a, '] (').concat(e, ') ') +
                  ...
                  o = function (n) {
                    void 0 === r[t[e][n]]
                      ...
                      : g(r[t[e][n]] === a[n], function () {
                          return (
                            'Expected dimension '.concat(r[t[e][n]], ' at axis ').concat(n, ' ') +
      ...
      computeConv2DInfo: Ko,
      computeConv3DInfo: qo,
      computeDefaultPad: Vo,
      computeDilation2DInfo: function (e, t, n, r, a, o) {
        void 0 === a && (a = 'NHWC');
        var i = e[3];
        return Ko(e, u(u([], s(t), !1), [i], !1), n, o, r, null, null, $o(a));
      },
      ...
      computePool3DInfo: function (e, t, n, r, a, o, i) {
        ...
        return qo(e, u, n, r, a, !1, c, o);
      },
      convertConv2DDataFormat: $o,
      decodeEinsumEquation: function (e, t) {
        var n = ((e = e.replace(/\s/g, '')).length - e.replace(kf, '').length) / wf.length;
        if (n < 1) throw new Error('Equations without an arrow are not supported.');
        if (n > 1) throw new Error('Equation must contain exactly one arrow ("'.concat(wf, '").'));
        var r = s(e.split(wf), 2),
          a = r[0],
          o = r[1];
        ...
        var i = a.split(','),
          u = i.length;
        if (t !== u) throw new Error('Expected '.concat(u, ' input tensors, received ').concat(t));
        if (u > 2) throw new Error('Support for more than 2 input tensors is not implemented yet.');
        for (
          var c = [],
            l = function (e) {
              var t = o[e];
        ...
        for (h = 0; h < u; ++h) {
          if (new Set(i[h].split('')).size !== i[h].length)
            throw new Error(
              'Found duplicate axes in input component '.concat(i[h], '. ') + 'Support for duplicate axes in input is not implemented yet.',
            );
          d[h] = [];
      ...
      getFusedBiasGradient: ll,
      getFusedDyActivation: cl,
      ...
      getRaggedRank: function (e) {
        return 0 === e.length ? 0 : e[0] === gf.FIRST_DIM_SIZE ? e.length - 1 : e.length;
      },
      getReductionAxes: Ki,
      ...
      getReshapedPermuted: function (e, t, n, r) {
        ...
        for (var o = 1; o < e.length; ++o) o <= t.length ? (r ? a.push(t[o - 1] * e[o]) : a.push(e[o] / t[o - 1])) : a.push(e[o]);
        return a;
      },
      getRowPartitionTypesHelper: function (e) {
        var t,
          n,
          r = {
            FIRST_DIM_SIZE: gf.FIRST_DIM_SIZE,
            VALUE_ROWIDS: gf.VALUE_ROWIDS,
            ROW_LENGTHS: gf.ROW_LENGTHS,
            ROW_SPLITS: gf.ROW_SPLITS,
            ROW_LIMITS: gf.ROW_LIMITS,
            ROW_STARTS: gf.ROW_STARTS,
          },
          a = [];
        try {
      ...
      log: function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        J().getBool('IS_TEST') || J().getBool('PROD') || console.log.apply(console, u([], s(e), !1));
      },
      mergeRealAndImagArrays: function (e, t) {
        if (e.length !== t.length)
          throw new Error(
            'Cannot merge real and imag arrays of different lengths. real:' + ''.concat(e.length, ', imag: ').concat(t.length, '.'),
          );
      ...
      segment_util: {
        ...
        collectGatherOpShapeInfo: function (e, t, n, r) {
          var a = t.shape.length,
            o = e.shape.length;
          if (0 !== r && (r < -a || r > a))
            throw new Error('Expect batchDims in the range of [-'.concat(a, ', ').concat(a, '], but got ').concat(r));
          if ((r < 0 && (r += a), r > o)) throw new Error('batchDims ('.concat(r, ') must be less than rank(x) (\n    ').concat(o, ').'));
          ...
          return { batchSize: c, sliceSize: h, outerSize: l, dimSize: s, outputShape: u };
        },
        computeOutShape: function (e, t, n) {
          for (var r = [], a = e.length, o = 0; o < a; o++) o !== t ? r.push(e[o]) : r.push(n);
          return r;
        },
        segOpComputeOptimalWindowSize: function (e, t) {
          var n,
            r = !1;
          for (e <= 30 ? ((n = e), (r = !0)) : (n = P(e, Math.floor(Math.sqrt(e)))); !r; ) n > t || n === e ? (r = !0) : (n = P(e, n + 1));
          return n;
        },
      },
      shouldFuse: fl,
      ...
      stridesOrDilationsArePositive: Qo,
      tupleValuesAreOne: Yo,
      upcastType: ea,
          ...
          if (n >= r)
            throw new Error(
              'defaultValue.shape='
                ...
                .concat(n, ' must be less than ragged tensor input flatValues.rank = ')
                .concat(r, ')'),
            );
      ...
      validateInput: Wc,
      validateUpdateShape: Uc,
      warn: Bn,
    },
    Sf = { __proto__: null, nonMaxSuppressionV3Impl: Rl, nonMaxSuppressionV4Impl: Bl, nonMaxSuppressionV5Impl: Fl, whereImpl: Yc };
  !(function () {
    var e, t;
    try {
      for (var n = i(Fh), r = n.next(); !r.done; r = n.next()) {
        Sh(r.value);
      }
    } catch (t) {
      e = { error: t };
    ...
    (e.Acos = Q),
    (e.Acosh = $),
    (e.AdadeltaOptimizer = Ih),
    (e.AdagradOptimizer = Nh),
    (e.AdamOptimizer = Mh),
    (e.AdamaxOptimizer = Th),
    (e.Add = ee),
    (e.AddN = te),
    (e.All = 'All'),
    (e.Any = 'Any'),
    ...
    (e.conv1d = Ii),
    (e.conv2d = _i),
    (e.conv2dTranspose = Mi),
    (e.conv3d = Ti),
    (e.conv3dTranspose = Ri),
    ...
    (e.deprecationWarn = function (e) {
      J().getBool('DEPRECATION_WARNINGS_ENABLED') &&
        console.warn(e + ' You can disable deprecation warnings with tf.disableDeprecationWarnings().');
    }),
    (e.depthToSpace = Li),
    (e.depthwiseConv2d = zi),
    (e.device_util = va),
    (e.diag = Ui),
    (e.dilation2d = Wi),
    (e.disableDeprecationWarnings = function () {
      J().set('DEPRECATION_WARNINGS_ENABLED', !1), console.warn('TensorFlow.js deprecation warnings have been disabled.');
    }),
    (e.dispose = Eo),
        ...
        function (t, n) {
          ...
          return da.tidy(function () {
            var t = da.gradients(
              ...
              o = t.grads;
            return (
              null != a && v(n.shape, a.shape, 'The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)'),
              Cs(o),
              o[0]
            );
          });
      ...
      return (
        ...
        function (t, n) {
          ...
          return da.tidy(function () {
            ...
            return (
              null != a &&
                v(n.shape, a.shape, 'The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])'),
              Cs(o),
              o
            );
          });
    ...
    (e.localResponseNormalization = Ts),
    (e.log = Ds),
    (e.log1p = Rs),
    (e.logSigmoid = Ls),
    (e.logSoftmax = Us),
    ...
    (e.meshgrid = function (e, t, n) {
      ...
      var i = ka(t, 'y', 'meshgrid', t instanceof Vr ? t.dtype : 'float32'),
        ...
        u = y(i.shape);
      return 'xy' === a
        ? ((o = ti(o, [1, -1])), (i = ti(i, [-1, 1])), [oi(eu([u, 1], o.dtype), o), oi(i, eu([1, s], i.dtype))])
        : ((o = ti(o, [-1, 1])), (i = ti(i, [1, -1])), [oi(o, eu([1, u], o.dtype)), oi(eu([s, 1], i.dtype), i)]);
    }),
    (e.min = os),
    (e.minimum = tu),
    (e.mirrorPad = nu),
    ...
    (e.raggedGather = wu),
    (e.raggedRange = ku),
    (e.raggedTensorToTensor = xu),
    (e.rand = Eu),
    (e.randomGamma = Qu),
    (e.randomNormal = $u),
    (e.randomStandardNormal = ec),
    (e.randomUniform = tc),
    (e.randomUniformInt = nc),
    (e.range = rc),
    (e.ready = function () {
      return da.ready();
    }),
    ...
    (e.registerGradient = function (e) {
      var t = e.kernelName;
      Cn.has(t) && J().getBool('DEBUG') && Bn("Overriding the gradient for '".concat(t, "'")), Cn.set(t, e);
    }),
    (e.registerKernel = zn),
    (e.relu = ic),
    (e.relu6 = sc),
    ...
    (e.unregisterKernel = function (e, t) {
      var n = Un(e, t);
      if (!Fn.has(n)) throw new Error("The kernel '".concat(e, "' for backend ") + "'".concat(t, "' is not registered"));
      Fn.delete(n);
    }),
    (e.unsortedSegmentSum = Zc),
    (e.unstack = Jc),
    (e.upcastType = ea),
