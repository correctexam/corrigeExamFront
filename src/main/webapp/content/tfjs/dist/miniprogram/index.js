...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('@tensorflow/tfjs-core'))
    : typeof define === 'function' && define.amd
    ? define(['exports', '@tensorflow/tfjs-core'], factory)
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self), factory((global.tf = global.tf || {}), global.tf));
})(this, function (exports, tfjsCore) {
  'use strict';
        ...
        if (ENVIRONMENT_IS_PTHREAD) {
          ...
          if (Module['wasmMemory']) {
            ...
            if (!(wasmMemory.buffer instanceof SharedArrayBuffer)) {
              err(
                'requested a shared WXWebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag',
              );
              if (ENVIRONMENT_IS_NODE) {
