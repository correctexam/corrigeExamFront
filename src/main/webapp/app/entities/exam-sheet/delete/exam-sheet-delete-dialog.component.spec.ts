...
describe('ExamSheet Management Delete Component', () => {
  ...
  let fixture: ComponentFixture<ExamSheetDeleteDialogComponent>;
  let service: ExamSheetService;
  let mockActiveModal: NgbActiveModal;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, FormsModule, ExamSheetDeleteDialogComponent],
      declarations: [],
      providers: [NgbActiveModal, provideHttpClient(), provideHttpClientTesting()],
    })
      .overrideTemplate(ExamSheetDeleteDialogComponent, '')
      .compileComponents();
    fixture = TestBed.createComponent(ExamSheetDeleteDialogComponent);
