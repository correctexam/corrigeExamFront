...
describe('CourseGroup Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'course-group', component: CourseGroupComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courseGroups?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
