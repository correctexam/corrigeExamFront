...
describe('StudentResponse Management Component', () => {
  let comp: StudentResponseComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(StudentResponseComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.studentResponses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
