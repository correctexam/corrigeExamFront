...
export class QuestionTypeComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.questionTypeService
      ...
      .subscribe({
        next: (res: HttpResponse<IQuestionType[]>) => {
  ...
  trackId(index: number, item: IQuestionType): number {
    return item.id!;
  }

  delete(questionType: IQuestionType): void {
    const modalRef = this.modalService.open(QuestionTypeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IQuestionType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
