var WasmBackendModuleThreadedSimd = (() => {
  ...
  return function (WasmBackendModuleThreadedSimd) {
    ...
    var __emscripten_thread_crashed = (Module['__emscripten_thread_crashed'] = function () {
      return (__emscripten_thread_crashed = Module['__emscripten_thread_crashed'] = Module['asm']['_emscripten_thread_crashed']).apply(
        null,
        arguments,
      );
    });
...
if (typeof exports === 'object' && typeof module === 'object') module.exports = WasmBackendModuleThreadedSimd;
else if (typeof define === 'function' && define['amd'])
  define([], function () {
    return WasmBackendModuleThreadedSimd;
  });
else if (typeof exports === 'object') exports['WasmBackendModuleThreadedSimd'] = WasmBackendModuleThreadedSimd;
