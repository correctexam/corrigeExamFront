...
class Galleria {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    ngImport: i0,
    type: Galleria,
    deps: [{ token: DOCUMENT }, { token: i0.ElementRef }, { token: i0.ChangeDetectorRef }, { token: i1.PrimeNGConfig }],
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { activeIndexChange: 'activeIndexChange', visibleChange: 'visibleChange' },
    host: { classAttribute: 'p-element' },
    queries: [{ propertyName: 'templates', predicate: PrimeTemplate }],
    viewQueries: [{ propertyName: 'mask', first: true, predicate: ['mask'], descendants: true }],
    usesOnChanges: true,
    ngImport: i0,
    template: `
    ...
    dependencies: [
      ...
      },
      {
        ...
        inputs: ['activeIndex', 'value', 'numVisible'],
...
class GalleriaContent {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [{ token: Galleria }, { token: i0.ChangeDetectorRef }, { token: i0.KeyValueDiffers }],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
    minVersion: '14.0.0',
    ...
    type: GalleriaContent,
    selector: 'p-galleriaContent',
    inputs: { activeIndex: 'activeIndex', value: 'value', numVisible: 'numVisible' },
    outputs: { maskHide: 'maskHide', activeItemChange: 'activeItemChange' },
    ngImport: i0,
    template: `
        <div
            [attr.id]="id"
    ...
    dependencies: [
      ...
      },
      {
        ...
        inputs: ['templates', 'index', 'item', 'type'],
      },
      {
        kind: 'component',
        type: i0.forwardRef(function () {
        ...
        outputs: ['startSlideShow', 'stopSlideShow', 'onActiveIndexChange'],
      },
      {
        kind: 'component',
        type: i0.forwardRef(function () {
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: Galleria }, { type: i0.ChangeDetectorRef }, { type: i0.KeyValueDiffers }];
  },
  propDecorators: {
    activeIndex: [
      {
...
class GalleriaItemSlot {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    type: GalleriaItemSlot,
    selector: 'p-galleriaItemSlot',
    inputs: { templates: 'templates', index: 'index', item: 'item', type: 'type' },
    ngImport: i0,
    template: `
    ...
    isInline: true,
    dependencies: [
      { kind: 'directive', type: i2.NgIf, selector: '[ngIf]', inputs: ['ngIf', 'ngIfThen', 'ngIfElse'] },
      {
        kind: 'directive',
...
class GalleriaItem {
  ...
  static ɵcmp = i0.ɵɵngDeclareComponent({
    ...
    outputs: { startSlideShow: 'startSlideShow', stopSlideShow: 'stopSlideShow', onActiveIndexChange: 'onActiveIndexChange' },
    usesOnChanges: true,
    ngImport: i0,
    template: `
...
class GalleriaThumbnails {
  ...
  static ɵfac = i0.ɵɵngDeclareFactory({
    ...
    deps: [{ token: Galleria }, { token: DOCUMENT }, { token: PLATFORM_ID }, { token: i0.Renderer2 }, { token: i0.ChangeDetectorRef }],
    target: i0.ɵɵFactoryTarget.Component,
  });
  static ɵcmp = i0.ɵɵngDeclareComponent({
    minVersion: '14.0.0',
    ...
    outputs: { onActiveIndexChange: 'onActiveIndexChange', stopSlideShow: 'stopSlideShow' },
    viewQueries: [{ propertyName: 'itemsContainer', first: true, predicate: ['itemsContainer'], descendants: true }],
    ngImport: i0,
    template: `
