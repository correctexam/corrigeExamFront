var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    if (B) {
      ...
      A ? (F = self.location.href) : 'undefined' != typeof document && document.currentScript && (F = document.currentScript.src),
    ...
    if (!C) {
      ...
      if (!(g.buffer instanceof SharedArrayBuffer))
        throw (
          ...
          B && I('(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)'),
          Error('bad memory'))
        );
      m();
    }
    ...
    function Ra(a, b) {
      var c = Na;
      return L || 'function' != typeof WebAssembly.instantiateStreaming || Ma(c) || oa(c) || B || 'function' != typeof fetch
        ? Qa(c, a, b)
    ...
    var Rb = {
      ...
      838303: () => 'undefined' !== typeof wasmOffsetConverter,
    };
    function Ta() {
    ...
    var Tb = a => {
      ...
      V = (a, b, ...c) => {
        for (var d = 2 * c.length, f = $b(), h = ac(8 * d), k = h >>> 3, q = 0; q < c.length; q++) {
          var y = c[q];
          'bigint' == typeof y ? ((N[k + 2 * q] = 1n), (N[k + 2 * q + 1] = y)) : ((N[k + 2 * q] = 0n), (ea()[(k + 2 * q + 1) >>> 0] = y));
        }
        a = bc(a, 0, d, h, b);
        cc(f);
        return a;
        ...
        a.onmessage = h => {
          ...
          if (h.targetThread && h.targetThread != K()) {
            ...
            q
              ...
              : I(`Internal error! Worker sent a message "${k}" to target pthread ${h.targetThread}, but that thread no longer exists!`);
          } else if ('checkMailbox' === k) Ca();
          else if ('spawnThread' === k) Wb(h);
          else if ('cleanupThread' === k) ic(T[h.thread]);
          else if ('killThread' === k) (h = h.thread), (k = T[h]), delete T[h], Tb(k), hc(h), S.splice(S.indexOf(k), 1), (k.Ra = 0);
    ...
    var rc = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0,
      sc = (a, b, c) => {
        ...
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
        if (16 < c - b && a.buffer && rc) return rc.decode(a.buffer instanceof SharedArrayBuffer ? a.slice(b, c) : a.subarray(b, c));
        for (d = ''; b < c; ) {
          var f = a[b++];
          if (f & 128) {
            var h = a[b++] & 63;
    ...
    function xa(a) {
      a >>>= 0;
      'function' === typeof Atomics.jb && (Atomics.jb(r(), a >>> 2, a).value.then(Ca), (a += 128), Atomics.store(r(), a >>> 2, 1));
    }
    var Ca = () => {
      var a = K();
      if (a && (xa(a), (a = vc), !Fa))
    ...
    function vb(a, b, c) {
      ...
      for (var d; (d = n()[b++ >>> 0]); ) {
        ...
        f &= 112 != d;
        c += f && c % 8 ? 4 : 0;
        Ac.push(112 == d ? u()[(c >>> 2) >>> 0] : 106 == d ? N[c >>> 3] : 105 == d ? r()[(c >>> 2) >>> 0] : ea()[(c >>> 3) >>> 0]);
        c += f ? 8 : 4;
      }
      return Rb[a](...Ac);
    }
    ...
    function Pb(a, b, c, d) {
      ...
      function y(e) {
        ...
        for (e = new Date(new Date(e.Ta + 1900, 0, 1).getTime()); 0 < p; ) {
          ...
          if (p > J - e.getDate())
            (p -= J - e.getDate() + 1), e.setDate(1), 11 > t ? e.setMonth(t + 1) : (e.setMonth(0), e.setFullYear(e.getFullYear() + 1));
          else {
    ...
    w._OrtCreateSessionOptions = (a, b, c, d, f, h, k, q, y, v) => (w._OrtCreateSessionOptions = Z.ca)(a, b, c, d, f, h, k, q, y, v);
    ...
    var wa = (a, b, c, d, f, h) => (wa = Z.Ga)(a, b, c, d, f, h),
      ...
      ac = a => (ac = Z.Oa)(a),
      $b = () => ($b = Z.Pa)();
    w.___start_em_js = 838360;
    w.___stop_em_js = 838421;
    function Lc() {
      var a = Z;
      a = Object.assign({}, a);
      var b = d => () => d() >>> 0,
